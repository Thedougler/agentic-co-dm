...
4. **Restated setup.** The same fact appearing in Glance, At the table, the narration, and Wiki facts. State it once, in the surface where the DM needs it at the moment they need it.
...
**Fix direction:** Show the body first — face, hands, posture, one habit the DM can perform. The role emerges from what she does, not from a label. Role, faction, and relationships belong in At a Glance or Wiki facts, not in the portrait.
