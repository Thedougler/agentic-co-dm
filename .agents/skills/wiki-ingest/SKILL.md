...
**Owner pages (npc, item, creature, vehicle, …):** file into `wiki/entities/{type}/` using frontmatter `type` (depth 1 only). Keep `category: entities`. Do not invent facet/rarity nests. Redirect stubs follow `wiki/AGENTS.md`.
