...
behind/ahead cuts when pacing is not obvious. How the Scene Resolves hands to
a beat on this session's skeleton. Default-mode action-card numbers MAY sit on
the beat; the beat stays a cockpit, never a second full owner page.
