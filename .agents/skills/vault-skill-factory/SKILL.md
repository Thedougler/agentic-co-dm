...
- `improve-description.py` — tighten the generated `description` for better triggering.
- `package-skill.py` — bundle the skill dir into a distributable archive.
- `quick-validate.py` — sanity-check the skill's structure.
