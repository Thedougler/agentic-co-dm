...
class MocGenerationTests(VaultFixture):
    ...
    def test_moc_generation_orders_links_excludes_infrastructure_and_is_idempotent(self) -> None:
        ...
        self.assertEqual(applied.returncode, 0, applied.stderr)
        entities = (self.vault / "entities/entities-index.md").read_text()
        npc = (self.vault / "entities/npc/npc-index.md").read_text()
        self.assertFalse((self.vault / "entities/_index.md").exists())
        self.assertFalse((self.vault / "entities/npc/_index.md").exists())
        ...
        self.assertIn("base_confidence: 0.55", entities)
        self.assertIn("- [[entities/npc/npc-index|Non-Player Characters]]", entities)
        ...
        self.assertIn("- [[entities/entities-index|Entities]]", root)
        self.assertIn("- [[entities/npc/npc-index|Non-Player Characters]]", root)
