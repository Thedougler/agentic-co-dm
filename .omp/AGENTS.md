...
Health: act on `next`, then remaining `focus`, without terminal detection or waiting for the DM. Creative lint remains on `scripts/wiki-lint`; `wiki-query` owns synthesized answers and citations.
