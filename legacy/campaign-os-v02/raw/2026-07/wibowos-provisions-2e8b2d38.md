...
On [[kalowe|Kalowe]]'s first island, harbour-side lane between the dry-dock offices and the primary berth. A ship's victualler: where captains send a crew member when they need to top off stores before leaving port.

**[[raw/2026-07/suryo-wibowo|Suryo Wibowo]]** — fifties, broad even for an orc, efficient. He works fast and talks at the same speed. He knows how long a given crew complement can run on a given number of stores, and he will tell a captain who is under-ordering in terms that are precise rather than unkind. He extends credit to captains he has dealt with three times or more; the terms are a handshake and a specific memory he keeps without a ledger.
...
- Short on salt pork — usual supplier from Dreth did not arrive last week; will run out in five days on a full provisioning order.
- A salt merchant mentioned a two-masted schooner drifting 4 miles north: green stripe, ochre hull, hatch open, no lights, no crew on deck, two nights running. *"First boarding party claims salvage under free-port custom."*
