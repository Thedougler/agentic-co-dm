...
updated: 2026-07-30
tags: [healing]
summary: "5e SRD reference for Hit Points, damage rolls, Resistance/Vulnerability/Immunity, Healing, Death Saving Throws, and Temporary Hit Points."
tier: supporting
source: "raw/2026-07/01_PlayingTheGame.md"
source_url: ""
campaigns: [Shattered Sea]
uid: 31dbbd2b-77d3-4d8f-8e16-eec23395802e
---

# Playing the Game (5e SRD) — Damage and Healing

Part of [[playing-the-game|Playing the Game (5e SRD)]].
...
Adventurers can't spend every hour adventuring. They need rest. Any creature can take hour-long Short Rests in the midst of a day and an 8-hour Long Rest to end it. Regaining Hit Points is one of the main benefits of a rest (Short and Long Rest rules themselves are not detailed in this source).
...
When attacking with a weapon, you add your ability modifier — the same modifier used for the attack roll — to the damage roll. A spell tells you which dice to roll for damage and whether to add any modifiers. Unless a rule says otherwise, you don't add your ability modifier to a fixed damage amount that doesn't use a roll, such as the damage of a [[blowgun|Blowgun]].

### Critical Hits

When you score a Critical Hit, you deal extra damage. Roll the attack's damage dice twice, add them together, and add any relevant modifiers as normal. For example, if you score a Critical Hit with a [[dagger|Dagger]], roll 2d4 for the damage rather than 1d4, and add your relevant ability modifier. If the attack involves other damage dice, such as from the [[rogue|Rogue]]'s Sneak Attack feature, you also roll those dice twice.
...
When you create a damaging effect that forces two or more targets to make saving throws against it at the same time, roll the damage once for all the targets. For example, when a wizard casts [[fireball|Fireball]], the spell's damage is rolled once for all creatures caught in the blast.
...
Each instance of damage has a type, like Fire or Slashing. Damage types have no rules of their own, but other rules, such as Resistance, rely on damage types (the full list of damage types is not enumerated in this source).
...
Some creatures and objects have [[immunity|Immunity]] to certain damage types and conditions. Immunity to a damage type means you don't take damage of that type, and Immunity to a condition means you aren't affected by it.

### Healing

Hit Points can be restored by magic, such as the *[[cure-wounds|Cure Wounds]]* spell or a *[[potion-of-healing-common|Potion of Healing]]*, or by a Short or Long Rest.
...
When you would reduce a creature to 0 Hit Points with a melee attack, you can instead reduce the creature to 1 Hit Point and give it the [[unconscious|Unconscious]] condition. It then starts a Short Rest, at the end of which that condition ends on it. The condition also ends early if the creature regains any Hit Points, or if someone administers first aid:

> [!check] Wisdom (Medicine) — Administering First Aid
> DC 10; anyone tending the unconscious creature may roll.
> **Success:** the Unconscious condition ends early.
> **Failure:** the condition continues.
...
If your character dies, others might find a magical way to revive your character, such as with the *[[raise-dead|Raise Dead]]* spell. Or talk with the GM about making a new character to join the group.
...
You can take the Help action to try to stabilize a creature with 0 Hit Points:

> [!check] Wisdom (Medicine) — Stabilizing a Dying Creature
> DC 10; anyone taking the Help action on the creature may roll.
> **Success:** the creature becomes Stable.
> **Failure:** the creature remains at 0 Hit Points, still making Death Saving Throws.
