...
updated: 2026-07-30
tags: [combat]
summary: "5e SRD combat rules: initiative and turn order, movement, making attacks, cover, ranged/melee attacks, opportunity attacks, mounted and underwater combat."
tier: supporting
source: "raw/2026-07/01_PlayingTheGame.md"
source_url: ""
campaigns: [Shattered Sea]
uid: 3933cf3c-71e9-44a7-b964-8aff7c6305ef
---

# Playing the Game (5e SRD) — Combat
...
Your movement can include climbing, crawling, jumping, and swimming (each defined elsewhere; this source does not define them itself). These different modes of movement can be combined with your regular movement, or they can constitute your entire move.
...
On your turn, you can give yourself the [[prone|Prone]] condition without using an action or any of your Speed, but you can't do so if your Speed is 0.

#### Creature Size

A creature belongs to a size category, which determines the width of the square space the creature occupies on a map, as shown below. Sizes range from smallest (Tiny) to largest (Gargantuan). A creature's space is the area that it effectively controls in combat and the area it needs to fight effectively.
...
During your move, you can pass through the space of an ally, a creature that has the [[incapacitated|Incapacitated]] condition, a Tiny creature, or a creature that is two sizes larger or smaller than you.
...
An attack unfolds in this sequence:

1. **Choose a Target.** Pick a target within your attack's range: a creature, an object, or a location.
2. **Determine Modifiers.** The GM determines whether the target has Cover (see below) and whether you have Advantage or Disadvantage against the target. In addition, spells, special abilities, and other effects can apply penalties or bonuses to your attack roll.
...
Some ranged attacks, such as those made with a [[longbow|Longbow]], have two ranges. The smaller number is the normal range, and the larger number is the long range. Your attack roll has Disadvantage when your target is beyond normal range, and you can't attack a target beyond long range.
...
If an effect is about to move your mount against its will while you're on it, or you're knocked Prone or the mount is, you must make this save:

> [!check] Dexterity — Staying Mounted
> DC 10; the rider rolls.
> **Success:** you stay mounted.
> **Failure:** you fall off, landing with the Prone condition in an unoccupied space within 5 feet of the mount.
