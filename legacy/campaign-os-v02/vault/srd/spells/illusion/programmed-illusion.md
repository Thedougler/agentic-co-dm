...
summary: "5e SRD spell text for Programmed Illusion."
subtype: illusion
tier: supporting
source: "raw/2026-07/07_Spells.md"
source_url: ""
uid: 88ee084d-a013-4709-8c1a-54919dad623e
---

# Programmed Illusion

**Level:** 6 — Illusion ([[bard|Bard]], [[wizard|Wizard]])
...
Physical interaction with the image reveals it to be illusory, since things can pass through it. A creature that takes the Study action to examine the image can determine that it is an illusion with a successful [[intelligence|Intelligence]] (Investigation) check against your spell save DC. If a creature discerns the illusion for what it is, the creature can see through the image, and any noise it makes sounds hollow to the creature. ^illusion-study-reveal
