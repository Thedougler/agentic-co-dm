...
summary: "5e SRD spell text for Major Image."
subtype: illusion
tier: supporting
source: "raw/2026-07/07_Spells.md"
source_url: ""
uid: 3fa8eb39-d9e2-4743-9a67-8dceee2d7333
---

# Major Image

**Level:** 3 — Illusion ([[bard|Bard]], [[sorcerer|Sorcerer]], [[warlock|Warlock]], [[wizard|Wizard]])
...
Physical interaction with the image reveals it to be an illusion, for things can pass through it. A creature that takes a Study action to examine the image can determine that it is an illusion with a successful [[intelligence|Intelligence]] (Investigation) check against your spell save DC. If a creature discerns the illusion for what it is, the creature can see through the image, and its other sensory qualities become faint to the creature.
