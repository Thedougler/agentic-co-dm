...
updated: 2026-07-30
tags: [faith, nature]
summary: "5e SRD spell text for Symbol."
subtype: abjuration
tier: supporting
source: "raw/2026-07/07_Spells.md"
source_url: ""
uid: d2d2774b-2c82-4859-8688-5eb1a301a02a
---

# Symbol

**Level:** 7 — Abjuration ([[bard|Bard]], [[cleric|Cleric]], [[druid|Druid]], [[wizard|Wizard]])
...
The glyph is nearly imperceptible and requires a successful [[wisdom|Wisdom]] (Perception) check against your spell save DC to notice.
...
![[glyph-of-warding#^refine-glyph-trigger]]
...
**_Death._** Each target makes a [[constitution|Constitution]] saving throw, taking 10d10 Necrotic damage on a failed save or half as much damage on a successful save.
...
**_Fear._** Each target must succeed on a Wisdom saving throw or have the [[frightened|Frightened]] condition for 1 minute. While Frightened, the target must move at least 30 feet away from the glyph on each of its turns, if able.

**_Pain._** Each target must succeed on a Constitution saving throw or have the [[incapacitated|Incapacitated]] condition for 1 minute.

**_Sleep._** Each target must succeed on a Wisdom saving throw or have the [[unconscious|Unconscious]] condition for 10 minutes. A creature awakens if it takes damage or if someone takes an action to shake it awake.

**_Stunning._** Each target must succeed on a Wisdom saving throw or have the [[stunned|Stunned]] condition for 1 minute.
