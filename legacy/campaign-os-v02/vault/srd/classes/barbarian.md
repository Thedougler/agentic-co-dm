...
updated: 2026-07-30
tags: [combat, war]
summary: "5e SRD Barbarian class rules: core traits, level 1-20 features, Rage mechanics, and the Path of the Berserker subclass."
tier: supporting
source: "raw/2026-07/01_Barbarian.md"
source_url: ""
uid: 053bc138-3d5a-4fba-939b-a67122166b01
---
...
| | |
|---|---|
| Primary Ability | [[strength\|Strength]] |
| Hit Point Die | D12 per Barbarian level |
| Saving Throw Proficiencies | Strength and [[constitution\|Constitution]] |
| Skill Proficiencies | Choose 2: Animal Handling, Athletics, Intimidation, Nature, Perception, or Survival |
| Weapon Proficiencies | Simple and Martial weapons |
| Armor Training | Light and Medium armor and Shields |
| Starting Equipment | Choose A or B: (A) [[greataxe\|Greataxe]], 4 Handaxes, [[explorers-pack\|Explorer's Pack]], and 15 GP; or (B) 75 GP |
...
**Duration.** The Rage lasts until the end of your next turn, and it ends early if you don Heavy armor or have the [[incapacitated|Incapacitated]] condition. If your Rage is still active on your next turn, you can extend the Rage for another round by doing one of the following:
...
While you aren't wearing any armor, your base Armor Class equals 10 plus your [[dexterity|Dexterity]] and Constitution modifiers. You can use a Shield and still gain this benefit.
...
> [!check] Constitution — Relentless Rage
> DC 10; if you drop to 0 Hit Points while your Rage is active and don't die outright, you may roll. Each time you use this feature after the first, the DC increases by 5. When you finish a Short or Long Rest, the DC resets to 10.
> **Success:** your Hit Points instead change to a number equal to twice your Barbarian level.
> **Failure:** you remain at 0 Hit Points.
...
In addition, your Rage is so fierce that it now lasts for 10 minutes without you needing to do anything to extend it from round to round. Your Rage ends early if you have the [[unconscious|Unconscious]] condition (not just the Incapacitated condition) or don Heavy armor.
...
You gain an Epic Boon feat (see "Feats") or another feat of your choice for which you qualify. [[boon-of-irresistible-offense|Boon of Irresistible Offense]] is recommended.
...
You have [[immunity|Immunity]] to the [[charmed|Charmed]] and [[frightened|Frightened]] conditions while your Rage is active. If you're Charmed or Frightened when you enter your Rage, the condition ends on you.
...
> [!check] Wisdom — Intimidating Presence
> DC 8 plus your Strength modifier and Proficiency Bonus; each creature of your choice in a 30-foot Emanation originating from you must save.
> **Success:** no effect.
> **Failure:** the creature has the Frightened condition for 1 minute. At the end of each of the Frightened creature's turns, the creature repeats the save, ending the effect on itself on a success.
