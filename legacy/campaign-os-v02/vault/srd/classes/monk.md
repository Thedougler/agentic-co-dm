...
updated: 2026-07-30
tags: [war]
summary: "5e SRD Monk class: core traits, level 1-20 features table and text, and the Warrior of the Open Hand subclass."
tier: supporting
source: "raw/2026-07/06_Monk.md"
source_url: ""
uid: 2525d873-213c-431d-a219-a83be9ebcc96
---
...
| Tool Proficiencies | Choose one type of Artisan's Tools or [[musical-instrument\|Musical Instrument]] (see "Equipment") |
| Armor Training | None |
| Starting Equipment | Choose A or B: (A) [[spear\|Spear]], 5 Daggers, Artisan's Tools or Musical Instrument chosen for the tool proficiency above, [[explorers-pack\|Explorer's Pack]], and 11 GP; or (B) 50 GP |
...
| 4 | +2 | [[ability-score-improvement\|Ability Score Improvement]], Slow Fall | 1d6 | 4 | +10 ft. |
...
Once per turn when you hit a creature with a Monk weapon or an Unarmed Strike, you can expend 1 Focus Point to attempt a stunning strike. The target must make a [[constitution|Constitution]] saving throw. On a failed save, the target has the [[stunned|Stunned]] condition until the start of your next turn. On a successful save, the target's Speed is halved until the start of your next turn, and the next attack roll made against the target before then has Advantage.
...
You don't benefit from this feature if you have the [[incapacitated|Incapacitated]] condition.
...
Through sheer force of will, you can remove one of the following conditions from yourself at the end of each of your turns: [[charmed|Charmed]], [[frightened|Frightened]], or [[poisoned|Poisoned]].

In addition, forgoing food and drink doesn't give you levels of [[exhaustion|Exhaustion]].
...
Warriors of the Open Hand — masters of unarmed combat — learn techniques to push and trip their opponents and manipulate their own energy to protect themselves from harm.
...
**Topple.** The target must succeed on a Dexterity saving throw or have the [[prone|Prone]] condition.

### Level 6: Wholeness of Body

You gain the ability to heal yourself. As a Bonus Action, you can roll your Martial Arts die. You regain a number of Hit Points equal to the number rolled plus your Wisdom modifier (minimum of 1 Hit Point regained).

You can use this feature a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a Long Rest. ^wis-mod-recharge
