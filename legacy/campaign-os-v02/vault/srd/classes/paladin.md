...
updated: 2026-07-30
tags: [faith]
summary: "5e SRD Paladin class: core traits, level 1-20 features, full spell list, and the Oath of Devotion subclass."
tier: supporting
source: "raw/2026-07/07_Paladin.md"
source_url: ""
uid: 16fa9252-3f55-4e22-8a24-68d00d859d30
---
...
| | |
|---|---|
| Primary Ability | [[strength\|Strength]] and [[charisma\|Charisma]] |
| Hit Point Die | D10 per Paladin level |
| Saving Throw Proficiencies | [[wisdom\|Wisdom]] and Charisma |
| Skill Proficiencies | Choose 2: Athletics, Insight, Intimidation, Medicine, Persuasion, or Religion |
| Weapon Proficiencies | Simple and Martial weapons |
| Armor Training | Light, Medium, and Heavy armor and Shields |
| Starting Equipment | Choose A or B: (A) Chain Mail, Shield, [[longsword\|Longsword]], 6 Javelins, [[holy-symbol\|Holy Symbol]], [[priests-pack\|Priest's Pack]], and 9 GP; or (B) 150 GP |
...
- Gain the Paladin's level 1 features from the Paladin Features table. See the multiclassing rules in "Character Creation" to determine your available spell slots.
...
### Paladin Features Table — Spell Slots per Spell Level
...
You can also expend 5 Hit Points from the pool of healing power to remove the [[poisoned|Poisoned]] condition from the creature; those points don't also restore Hit Points to the creature.
...
**Blessed Warrior.** You learn two [[cleric|Cleric]] cantrips of your choice (see the Cleric class's section for a list of Cleric spells). *[[guidance|Guidance]]* and *[[sacred-flame|Sacred Flame]]* are recommended. The chosen cantrips count as Paladin spells for you, and Charisma is your spellcasting ability for them. Whenever you gain a Paladin level, you can replace one of these cantrips with another Cleric cantrip.

### Level 2: Paladin's Smite

You always have the *[[divine-smite|Divine Smite]]* spell prepared. In addition, you can cast it without expending a spell slot, but you must finish a Long Rest before you can cast it in this way again.
...
You can call on the aid of an otherworldly steed. You always have the *[[find-steed|Find Steed]]* spell prepared.
...
As a Magic action, you can expend one use of this class's Channel Divinity to overwhelm foes with awe. As you present your Holy Symbol or weapon, you can target a number of creatures equal to your Charisma modifier (minimum of one creature) that you can see within 60 feet of yourself. Each target must succeed on a Wisdom saving throw or have the [[frightened|Frightened]] condition for 1 minute or until it takes any damage. While Frightened in this way, a target can do only one of the following on its turns: move, take an action, or take a Bonus Action.

### Level 10: Aura of Courage

You and your allies have [[immunity|Immunity]] to the Frightened condition while in your Aura of Protection. If a Frightened ally enters the aura, that condition has no effect on that ally while there.
...
When you use Lay On Hands on a creature, you can also remove one or more of the following conditions from the creature: [[blinded|Blinded]], [[charmed|Charmed]], [[deafened|Deafened]], Frightened, [[paralyzed|Paralyzed]], or [[stunned|Stunned]]. You must expend 5 Hit Points from the healing pool of Lay On Hands for each of these conditions you remove; those points don't also restore Hit Points to the creature.
...
You gain an Epic Boon feat (see "Feats") or another feat of your choice for which you qualify. [[boon-of-truesight|Boon of Truesight]] is recommended.
...
|-------|--------|---------|
| [[bless\|Bless]] | Enchantment | C, M |
| [[command\|Command]] | Enchantment | — |
...
| Spell | School | Special |
|-------|--------|---------|
| [[create-food-and-water\|Create Food and Water]] | Conjuration | — |
...
| Spell | School | Special |
|-------|--------|---------|
| [[aura-of-life\|Aura of Life]] | Abjuration | C |
