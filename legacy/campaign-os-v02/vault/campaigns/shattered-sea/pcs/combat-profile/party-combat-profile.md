...
owner_skill: "vault/campaigns/.claude/skills/combat-profiles/SKILL.md"
party_level: 5
party_size: 5
last_simulated: "never"
sim_seed: "none"
sim_version: "none"
...
tags: [combat]
uid: d0f51e70-174b-41b6-9828-409d13d93133
---
...
|---|---|---|---|---|
| Delmar | 18.13 (Blunderbuss +8, [[sneak-attack\|Sneak Attack]] 3d6 always-on) | 18.13 (no round-1 burst beyond the routine; Lucky rerolls unmodeled) | 16 / 69 | WIS +1, STR +0 |
| Crissdalynn | 12.63 (Quarterstaff +7, bonus Unarmed +8) | 19.50 ([[flurry-of-blows\|Flurry of Blows]], 1 Focus Point) | 17 / 70 | CHA +0, INT +0 |
| Jean-Claude | 11.60 (2× +1 Silent Shortbow +9) | 17.20 (+ Dreadful Strike 2d6, 2/long rest) | 16 / 80 | CHA -1, INT +0 |
| Perrin | 10.25 ([[green-flame-blade\|Green-Flame Blade]] +8) | 10.25 ([[hex\|Hex]] costs round 1's bonus action; 12.88 from round 2) | 18 / 109 | STR -1, and disadvantage on STR (Mortis) |
| Catarina | 8.80 ([[fire-bolt\|Fire Bolt]] +9) | 24.00 ([[scorching-ray\|Scorching Ray]] 2nd + Eldritch Cannon Force Ballista) | 16 / 69 | CHA +0, WIS +1 |
...
per round ([[uncanny-dodge|Uncanny Dodge]]), Crissdalynn takes 1d10+9
...
[[war-caster|War Caster]] — a single focused hit drops
[[faerie-fire|Faerie Fire]] or [[hex|Hex]]. Perrin's STR save is -1 with
...
boosted save resists [[ozzeth-the-twiceborn|Ozzeth]]'s
[[dominate-person|Dominate Person]] via Delmar (S06).
[[healing-word|Healing Word]] and [[cure-wounds|Cure Wounds]] sustain
...
the DM raised [[otar-the-foul|Otar the Foul]] to CR 12 on that basis,
