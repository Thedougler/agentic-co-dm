...
publish: false
aliases: []
summary: "A displaced entity from the Elemental Plane of Water, possibly responsible for sinking the Vestra."
created: 2026-07-30
updated: 2026-08-08
tags: [horror]
tier: supporting
...
reference_image: ""
uid: eabae496-21e5-49e8-9700-a923fc8530ff
---
...
[[perrin-black-jaw|Perrin Black-Jaw]]'s account is the closest thing to firsthand testimony: something massive rose under the *[[vestra|Vestra]]*, the water boiled, lightning cracked a clear sky, and then there was nothing. He never said no one else survived. [[nona-black-jaw|Nona Black-Jaw]] understood anyway when he tried to tell her in her kitchen. He named it "the Leviathan" only afterward, never at the table, once he needed a word for what took his family's ship.

Whether it actually sank the *Vestra* stays the open question the table hasn't closed: it's the leading account, medium confidence, with [[umberlee|Umberlee]]'s own motive against Fisk's fleet running as the strongest counter-theory (full case notes in `Inbox/situations/active/what-sunk-the-vestra.md`). The table has settled one fact under that question, not theory: [[auralis|Auralis]], not the cloak Perrin credits, actually kept him alive in the wreck, forging an unwitting warlock pact between them that the table doesn't have yet (see [[perrin-black-jaw|Perrin Black-Jaw]] § Arc Notes). He washed up alone on [[keth-naar|Keth Naar]] afterward, the only *Vestra* survivor anyone's found.
...
|---|---|---|---|
| Cut it loose mid-grapple | The Leviathan's Crushing Coil holds a creature | Breaking the grip early costs the Leviathan its follow-up attack that turn and briefly exposes the coil to a called shot | [[perrin-black-jaw\|Perrin Black-Jaw]] (the only known survivor of a Vestra-scale grip) |
| Read the boil before the strike | Riftbolt is off recharge, about to fire | Watching the water for the heat shimmer buys one round's warning before the lightning line comes | [[vestra\|Vestra]] |
| Drive it back toward the breach | The fight happens within reach of The Drowned Maw's fissure | Forcing it toward the rift risks reopening the pull the Pearl of Souls created, and something larger is still pushing from the other side | [[pearl-of-souls\|Pearl of Souls]], [[elemental-plane-of-water\|Elemental Plane of Water]] |
...
actions:
  ...
  - name: "Crushing Coil"
    desc: "Melee Weapon Attack: +14 to hit, reach 20 ft., one creature. Hit: 30 (4d10 + 8) bludgeoning damage, and the target is [[grappled|Grappled]] (escape DC 22). Until this grapple ends, the target is [[restrained|Restrained]], and the Leviathan can't use Crushing Coil on another target."
