...
uid: 16f57f59-6015-44e6-b845-c4e10e6bd9d0
---

# Cursed Bracers of Archery
...
| Field | Value |
|---|---|
| one_thing | While worn and attuned, grants proficiency with the longbow and shortbow and a +2 bonus to damage rolls made with them, the standard [[bracers-of-archery\|Bracers of Archery]] effect. It also carries two paired curses. One triggers on a natural 1, turning the wearer a random neon color for an hour and leaving one permanent patch behind. The other triggers on a natural 20, compelling a loud, involuntary boast that can blow the wearer's cover. |
...
| current_holder | [[jean-claude-tabarnack\|Jean-Claude Tabarnack]], carried in his kit. |
...
**Archer's Bracers [RAW, Bracers of Archery].** While wearing these bracers, you have proficiency with the [[longbow|Longbow]] and [[shortbow|Shortbow]], and you gain a +2 bonus to damage rolls made with such weapons.
...
When the hour ends, the color fades from everywhere except one random patch of skin, which stays that color permanently. Only [[remove-curse|Remove Curse]] or a comparable curse-breaking effect removes the permanent mark.
...
Sold by [[lavinia-sordi|Lavinia Sordi]] from her rack at [[la-cenere|La Cenere]] in [[le-paludi|Le Paludi]], [[calveno|Calveno]], for 100 gp, Session 8. [[jean-claude-tabarnack|Jean-Claude Tabarnack]] had it identified shortly after, which is when the nat-1 curse first came to light. The random color that came up was flamingo pink.
