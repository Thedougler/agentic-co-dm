...
updated: 2026-07-30
tags: [combat]
summary: "Rules for running horde combat by pooling monster damage, adjusting attack/save resolution, and adjudicating area effects against large groups."
tier: supporting
source: "raw/2026-07/23 - Running Hordes.md"
source_url: ""
uid: fdc3c2b9-2a03-4951-9bd6-542cc9e8c26b
---

# Running Hordes (Lazy GM Resource Document)

This guide helps run battles in which the characters face large numbers of monsters. To accommodate running horde combat, the rules for running monsters change in two ways: adjusting how damage done to monsters in a horde is tracked, and how attack rolls and saving throws for the horde are adjudicated. These approaches can be used individually or together when running large numbers of monsters.

## Pooling Damage

Pooling damage means that instead of tracking the damage dealt to individual monsters, damage dealt to the horde as a whole is tracked. Add up the damage of each attack, regardless of which monster in the horde is hit. Then every time the total of damage taken is higher than the hit points of a single monster in the horde, remove the last monster hit and reset the damage dealt to zero.
...
To make this math even easier, round each monster's hit points to the nearest 5 or 10.
...
Adjudicate the number of creatures caught up in an area of effect based on the circumstances, but lean toward more creatures rather than fewer. Use the following as a baseline for the number of tightly packed creatures in a horde that are affected in a given area:
