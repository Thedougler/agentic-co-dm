...
updated: 2026-07-30
tags: [nature]
summary: "Five monster templates (elemental, dire, fiendish, spell-infused) for customizing existing monster stat blocks into new variants, with CR-adjustment guidance."
tier: supporting
source: "raw/2026-07/21 - Monster Templates.md"
source_url: ""
uid: 3afe3fa3-70b5-471c-94fd-4fb64679cd4c
---

# Monster Templates (Lazy GM Resource Document)

The following monster templates can help customize existing monsters into new unique variants that can fit a variety of locations and circumstances. With just a few templates in hand, core monster books can become much more useful.

## Challenge Rating Increase?

The challenge ratings described in these templates are loose guides — use best judgment with them. Apply these templates only when there's a good handle on the characters' capabilities, and be prepared to tune the new monsters accordingly.

## Elemental Monsters

Apply this template to any monster to make an elemental version of that monster. Choose from or roll on the following table to determine the type of elemental template to apply:
...
Then choose one or more of the following traits to customize the monster, making use of the damage type determined by the elemental template:
...
- The monster can use one or more of its standard attacks multiple times on its attack action. Use best judgment to choose which of the monster's attacks to use for multiple attacks.
