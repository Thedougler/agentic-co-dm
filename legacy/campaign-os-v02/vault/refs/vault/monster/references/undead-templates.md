...
updated: 2026-07-30
tags: [undead]
summary: "Templates for turning any monster into a skeleton, zombie, ghoul, wight, wraith, or vampire spawn via universal and type-specific trait, resistance, and immunity changes."
tier: supporting
source: "raw/2026-07/22 - Undead Templates.md"
source_url: ""
uid: 498f32fc-cf7e-4e46-bee8-aa4762590dc6
---

# Undead Templates (Lazy GM Resource Document)

You can easily create an undead variant of any monster simply by giving it the undead type and describing its undead appearance, letting the narrative feed the players' impression of fighting undead without requiring any mechanical changes. But for even more realistic undead, you can use any of the following templates to give a monster some of the properties and attributes of a specific type of undead creature.
...
* [[immunity|Immunity]] to poison damage, to exhaustion, and to the poisoned condition.

## Zombie

* Immunity to poison damage and the poisoned condition.
* **Undead Fortitude.** If damage reduces the creature to 0 hit points, it must make a [[constitution|Constitution]] saving throw with a DC of 5 + the damage taken, unless the damage is radiant or from a critical hit. On a success, the creature drops to 1 hit point instead.
...
* The creature gains the [[wight|Wight]]'s Life Drain trait (see above).

## Vampire Spawn

* Resistance to necrotic, bludgeoning, piercing, and slashing damage from nonmagical attacks.
* The creature has the vampire spawn's [[spider-climb|Spider Climb]], Vampire Weaknesses, and Regeneration traits.
