...
created: 2026-07-30
updated: 2026-07-30
tags: [stealth, survival, exploration, heist, travel]
summary: "Sly Flourish's LGMRD system for running wilderness travel via character roles (Trailhand, Scout, Quartermaster), group stealth, and a three-step framework for building a wilderness journey."
tier: supporting
source: "raw/2026-07/14 - Wilderness Travel and Exploration.md"
source_url: ""
uid: 2e4446b4-ed7b-4dd3-9d60-9f36842ea078
---

# Wilderness Travel and Exploration (Lazy GM Resource Document)

This section offers a systematic approach for handling travel through wild lands filled with potential dangers, and can be used with both point crawls or hex crawls.

This page covers the role mechanics only. Designing what actually happens on a leg — which events, each one derived from a named PC thread, faction front, or spotlight need — is the `travel-events` skill's job (`.claude/skills/travel-events/SKILL.md`); at sea, the stations come from [[ship-operations|Ship Operations]] § Stations Underway.

> [!mechanic]
> **Travel activity checks (Nature, Survival, Medicine, Perception, Insight).** Characters make checks for travel roles and group stealth during wilderness travel. Set DCs between DC 10 (easy) and DC 20 (very hard), defaulting to DC 12. On failure, characters may become lost, encounter hostile creatures unexpectedly, expend extra resources, or face exhaustion depending on the specific activity.
...
If the characters decide to move stealthily through the wilderness, doing so doubles the length of their travel time and might impose disadvantage on other checks at your discretion. To move stealthily through the wilderness, the characters make a group [[dexterity|Dexterity]] (Stealth) check and compare that result to the passive [[wisdom|Wisdom]] (Perception) scores of any potentially hostile creatures that might spot or hear them.
...
As the characters travel through the wilderness, choose or randomly select potential encounters. These might be face-to-face encounters with denizens of the wilderness, but not all such encounters need to be hostile. The characters could run into friendly travelers, fearful monsters, weak foes, or signs of a previous battle. Likewise, they might spot the tracks of creatures that passed by within the last day, or that are heading in the party's direction.
