...
updated: 2026-08-08
tags: [survival]
summary: "Sly Flourish's LGMRD method for building a campaign outward from a starting location, using a one-sentence pitch, six truths, campaign fronts, and randomizable location/front tables."
tier: supporting
source: "raw/2026-07/10 - Spiral Campaign Development.md"
source_url: ""
uid: bc49b710-5f1e-4f55-99db-2239c33c6df4
---

# Spiral Campaign Development (Lazy GM Resource Document)
...
Roll or pick from this table of 20 example campaign pitches:
...
8. [[shatter|Shatter]] the draconic Alliance of Five Claws
...
As the campaign spirals outward, the characters will become aware of local adventuring locations. Drop three such adventure locations into the areas close by the starting location. If you need help filling out an adventure location, look to later sections of the source document (not included here — the source references sections beyond this one without including their content).
