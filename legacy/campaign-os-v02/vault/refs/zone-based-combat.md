...
updated: 2026-07-30
tags: [combat]
summary: "Sly Flourish's zone-based combat system replaces the 5-foot grid with abstract zones (~25 feet per side) for faster, narrative-friendly combat."
tier: supporting
source: "raw/2026-07/19 - Zone-Based Combat.md"
source_url: ""
uid: 718043ee-3c43-4f18-b65e-35ba840b6475
---

# Zone-Based Combat (Lazy GM Resource Document)

Zone-based combat helps GMs run fast, dynamic, high-action combat without tracking all the details of tactical combat on a grid. It supports multiple combat styles, including pure narrative theater-of-the-mind combat, quickly drawn abstract sketches, or miniatures used with detailed maps or 3D terrain. Using zone-based combat means worrying less about the details of a 5-foot-per-square grid and focusing more on big heroic action. It requires the GM and the players to work together with the shared goal of creating fantastic stories of high adventure.

## Zone Rules

The following guidelines establish the broad strokes of zone-based combat:

- [Combat](vault/srd/rules/combat.md) areas are made up of one or more zones, each roughly 25 feet on a side, but a zone can be any size.
...
- If a character attacks with or is attacked by a melee attack with a 5-foot reach, that character provokes opportunity attacks if they attempt to move away from their opponent. A character attacked by a melee attack with a 5-foot reach also has disadvantage on ranged attacks.
...
GMs can adjudicate and adjust these numbers based on the current situation. For example, an area containing a horde of monsters might double the potential number of monsters affected. Whatever the circumstances, a GM should always adjudicate in favor of the characters.
