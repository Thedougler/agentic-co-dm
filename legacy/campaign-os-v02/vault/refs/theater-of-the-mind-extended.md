...
updated: 2026-07-30
tags: [combat]
summary: "Sly Flourish's extended guidelines for running D&D combat in the theater of the mind, without a grid or miniatures."
tier: supporting
source: "raw/2026-07/17 - Theater of the Mind Guidelines (Extended).md"
source_url: ""
uid: be1cbbfb-c58b-4fc2-8891-a08bc13d5867
---

# Theater of the Mind Guidelines — Extended (Lazy GM Resource Document)

These guidelines help Gamemasters run combat in the "theater of the mind," without the need for a gridded battle map or miniatures. This style of combat takes the emphasis away from tactical features such as distance, range, and the specific size of areas of effect. Instead, it focuses on the in-game action, the intent of the characters, and what happens in the story.

This style of combat works just like any other scene in the game. On each player's turn, the GM describes the current situation, the players describe their intent, and the GM adjudicates what happens as a result.

Theater-of-the-mind combat requires that the players trust the GM, knowing that the GM will describe the situation and adjudicate the results of the characters' actions fairly. The GM earns this trust by favoring the players whenever possible, and by focusing on sharing an action-packed story.

Running theater-of-the-mind combat removes agency from the players — it takes away their ability to control every aspect of how their characters move and what they do. The GM can mitigate this by asking each player for their intent each turn, then helping them meet that intent. For example, a player who says "I move close to the orcs" potentially leaves too many possibilities open, so the GM should encourage the player to focus their intent more — perhaps along the lines of, "I want to position myself so that at least two orcs are within the reach of my glaive."

When playing in the theater of the mind, both the GM and the players must worry less about the mechanical details of the game. Instead, everyone focuses on the action and the story.
...
As the GM describes the features of the area, the GM makes a note of which ones can provide cover to the characters or their enemies, and how much cover.
...
Abilities like the evoker's Sculpt Spells feature can increase the number of affected enemies, usually by one or two. Likewise, an area of effect that targets both the characters and their enemies might affect more total targets — including an effect created by a character or monster willing to put allies in harm's way. If a spellcaster character wishes to place allies within an area of effect, the GM and the players should negotiate this before the spell is cast.

## Locations, Features, Environment, and Terrain

When first describing the combat encounter, the GM describes notable locations, objects, environmental features, and terrain features. Writing these down and keeping them in front of the players helps them visualize the battlefield. Players can interact with these environmental features, through such actions as swinging from magical chandeliers, climbing up obsidian cliffs to advantageous positions, or hiding behind ruined statues. If any feature or effect creates difficult terrain, the GM lets the players know how this might affect them, such as requiring that they use the Dash action to get out of the area.

## Randomly Selected Targets

The GM avoids biases — whether perceived or actual — by randomly selecting targets when it isn't clear which character a monster would attack. Rolling randomly for targets in the open can help build trust between the GM and the players, letting them know that the GM isn't picking on anyone. Monsters aren't idiots, though: if it's clear that a monster would attack a particular character, such as a wizard concentrating on a dangerous spell, the monster will do so. When this happens, the GM just describes why the monster chose that particular character, so the players understand.
...
Theater-of-the-mind combat can go stale if the GM doesn't continually reinforce the story of what's happening. Go big with descriptions of the location and the action. Ask players to describe their attacks and killing blows. Between turns, describe the current situation using in-story language. These descriptions are vital to keeping the scene interesting.
