...
updated: 2026-07-30
tags: [craft]
summary: "Safety tools for TTRPG play — sensitive-topic discussion, hard lines vs. off-screen content, and the 'pause for a second' verbal cue — from the Lazy GM Resource Document."
tier: supporting
source: "raw/2026-07/08 - Safety Tools.md"
source_url: ""
uid: dbff6bb4-e758-4673-957b-e3a1ed349788
---

# Safety Tools (Lazy GM Resource Document)

Safety tools help ensure that you and your players are always comfortable with the subject matter of the games you run — especially when that subject matter involves potentially troubling tropes or themes. The safety tools presented here can be used individually or together to make sure that everyone is comfortable with the material in the game, even as that material evolves during play. Choose which safety tools work well for you and your group, and discuss their use early in your game — usually during your campaign's session zero, or at the beginning of a single-session game.

## Potentially Sensitive Topics

When you discuss safety tools, describe potentially sensitive topics that might come up in an adventure or campaign. The following list presents topics that are good to talk about, but it is not exhaustive.
...
When describing these topics, ensure that the players are comfortable with them. Also identify which topics they are not comfortable with, so you can omit that material from your game.

## Hard Lines and Off-Screen Content

This table's actual current Lines and Veils are recorded in
[lines-and-veils.md](lines-and-veils.md) — apply those, not the generic
example below.

The concept of hard lines and off-screen content allows you to set parameters for handling sensitive topics in your game. Once you've had a discussion with your players on those topics, talk about whether individual topics should be a hard line (material that should never come up) or content that can be described vaguely and handled off-screen. For example, after discussion, you and your players might come up with something like the following:
