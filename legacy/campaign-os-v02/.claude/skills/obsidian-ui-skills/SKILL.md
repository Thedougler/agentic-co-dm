...
description: >-
  obsidian-ui-skills — Obsidian's own UI design-system tokens (colors, typography, spacing,
  borders, components) for a Campaign OS repo. Use when building or styling a tool interface
  (e.g. utils/site/ or a dev dashboard) in Obsidian's dark-mode, Inter-font, 4px-grid aesthetic.
  Not for the vault's own visual styling — that's obsidian-layout-adjustment.
---
