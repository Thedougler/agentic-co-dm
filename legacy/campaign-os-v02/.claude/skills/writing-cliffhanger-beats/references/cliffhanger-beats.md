...
When system-specific encounter balance matters, use the repository's current mechanics/tooling as the authority. This skill determines dramatic function, not encounter math.
