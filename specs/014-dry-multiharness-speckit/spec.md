...
- **FR-003**: Project principles MUST have exactly one authoritative copy in the constitution. Other agent-facing files MUST reference or read it at runtime, not copy it. Checkable rule: `AGENT003`.
