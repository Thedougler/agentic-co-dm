...
**Constraints**: FR-002 length is not the gate. FR-008 routing fires without loading a skill-authoring playbook. FR-013 closed in-scope set. Constitution VII — do not prescribe how the designated writer designs. Constitution IX — standing gate stays short; procedure disclosed. Constitution X — do not ask the owner to classify, park, or commit.
