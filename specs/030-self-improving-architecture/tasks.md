...
- [ ] T014 [US1] Drain Vale entries e-212, e-214, e-215, e-216, and e-218 from `errors.md` with the current CLI (`error drain --id <id> --cause-fixed true`, before T065), in the same commit as T007 and T013 (FR-008)
