...
visibility: dm
tags: [location, grung, verdant-teeth, sorn, botukuri]
---
# Sorn
> [!narration] Narration
...
## Playable structure
- `reef -- worked approach --> [[Sorn Guarded Beach]]` (clean landing, purple watch).
- `Sorn Guarded Beach -- first lanes --> Botukuri farms` (social breach, water and silt hazards).
- `Botukuri farms -- flood routes / recut edges --> closed ridge` (seasonal, information-rich, not a public road).
