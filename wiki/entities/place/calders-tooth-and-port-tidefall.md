...
summary: "Cliff tiers hold Port Tidefall's docks, trade shelf, and Fort Crestwall above the western Strait."
provenance:
  extracted: 1.0
  inferred: 0.0
  ambiguous: 0.0
...
## At a Glance
The cliff tiers place docks at the water, a trade shelf on the face, and [[fort-crestwall]] with its guns on the crown. Every ship entering the western Strait must stop at the Inspection Pier and show papers.

## Two authorities
[[governor-voss]] holds the civic seat. The Admiralty controls the sealed orders. Voss is kept out of those orders, so two authorities share one harbour and the one with the guns does not always copy the one with the petitions.

Charts are sold over a counter. Vessel ratings are written down. Black nooses hang over the gate, with no public account of when they went up.
...
Calder's Tooth is a jagged limestone-and-basalt island at the [[central-strait]]'s west mouth. The west face is sheer. The east side slopes into mudflats and mangroves. A fog-thick ridge called the [[the-marrow|Marrow]] runs north to south with sinkholes and collapsed caves.
...
## Secrets
The sealed Crestwall orders and the vaults beneath the fort are separate layers of Crown secrecy. The Governor never saw the orders and lacks the reason for the extra companies. The Tessarine house is a separate pressure: legal paper, credit, and sealed mail rather than Admiralty force.
