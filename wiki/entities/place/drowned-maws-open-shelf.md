...
aliases:
  ...
  - "Drowned Maws Open Shelf"
  - "Open Shelf"
category: entities
tags: [shattered-sea, place]
sources:
  - "wiki/_archive/drowned-maws-open-shelf.md"
  - "wiki/_archive/drowned-maws-open-shelf-run-guide.md"
  - "wiki/_archive/drowned-maws-open-shelf-narration-condition.md"
  - "campaign-os:drowned-maws-open-shelf.md"
summary: "Warm, still Maw water over intact workshops at eighty feet, ruin-shadows forty feet down, a dead-fish and hot-iron smell."
provenance:
  extracted: 0.85
  inferred: 0.10
  ambiguous: 0.05
...
The richest reachable Antheri workshops lie inside water that grows hotter each time the breach presses upward. Salvagers stripped the upper Shelfworks bare. Intact workshops remain at eighty feet, but the lower tier stands abandoned after hot water burned through a crew's line. Beneath it, the Pearl of Souls keeps calling across the planar boundary while Auralis's containment loses ground.
...
The upper Shelfworks flood, the gold rush ends, and the Pearl's signal draws a larger incursion through the widening breach.
