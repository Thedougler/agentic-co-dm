...
visibility: dm
summary: "A canal-city halfling who sells alchemical cigarettes off a board under the Bridge, stocked from Studio Orsini's rejected batches."
provenance:
  extracted: 0.85
  inferred: 0.10
  ambiguous: 0.05
...
**Wants:** a door and a lock on [[the Bridge]]'s middle tier before the Beffa crowds thin, and he is funding it with stock a supplier has started asking questions about.
