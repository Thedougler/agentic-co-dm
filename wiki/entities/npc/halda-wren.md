...
sources:
  - "quest-penance-bar.md"
summary: "Draft-only woman at Sandy Grove who trades willowbark for salt fish and says the grove was never asked into town."
provenance:
  extracted: 1.0
  inferred: 0.0
  ambiguous: 0.0
...
flexGrow=1
===
> [!narration] Halda Wren
> A woman splits kindling beyond the last field of [[penance-bar|Penance Bar]]. She works without hurrying and speaks as if the grove has its own boundary: it was never asked into town, and it does not need to be.
```
````
