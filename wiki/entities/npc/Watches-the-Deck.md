...
faction: none
visibility: dm
summary: "A Lizardfolk regular at the Tallow Row card den, built long and rangy, who watches the deck instead of the room."
provenance:
  extracted: 0.85
  inferred: 0.10
  ambiguous: 0.05
...
| **Role**   | Contact and card-table observer |
| ---------- | -------------------------------- |
| **Nature** | Patient Lizardfolk regular who notices when a hand feels wrong. |
| **Home**   | [[Tallow Row]] |
| **Wants**  | Notice a hand before it turns into a lie without becoming the table's target. |

> **DM thesis:** Watches-the-Deck is a quiet observer whose attention becomes leverage when the game turns dishonest.
```
...
Place her beside the felt at [[Tallow Row]], watching the deck rather than the room. She answers a direct question only after deciding whether the hand or the speaker is worth watching.

**Sample line:** “The deck is telling you something. You are choosing not to hear it.”
```
