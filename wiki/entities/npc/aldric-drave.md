...
summary: "Real target of the Pearl theft that the Chain Council did not know it served."
provenance:
  extracted: 1.0
  inferred: 0.0
  ambiguous: 0.0
...
- [[calders-tooth-and-port-tidefall]]: the city he lives beneath.
...
- [[tessarine-concordat]]: its containment effort has targeted him from the start.
- [[barnaby-rook]]: a Crown privateer captain serving the bureaucracy Aldric secretly built, unaware.
- [[cosimo-verantio]]: rival for the Pearl of Souls, and the Concordat operative closest to exposing him.
...
- The crew connects three threads into one: the genealogical anomaly in Crown records, the sealed [[Drave Vaults]], and the two garrison detachments secretly holding [[fort-crestwall]] on his orders.
- The crew recovers the [[pearl-of-souls]], or asks pointed genealogy questions that reach deep Crown files.
...
**PC connection:** [[jean-claude-tabarnack]]'s established read on Dravosi proxy weakness (s04, s08) puts him first in position to notice the genealogical anomaly.
**Quest link:** none yet
