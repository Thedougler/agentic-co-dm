...
summary: "Wizard identified only by initials who bound and later freed Sir Quackers; whereabouts and identity remain unknown."
provenance:
  extracted: 1.0
  inferred: 0.0
  ambiguous: 0.0
...
faction: none
visibility: dm
canon_status: unresolved_backstory
---
# RTLB
...
===
> [!narration] RTLB
> No physical description of RTLB is established. The only known identity is the three-letter name Sir Quackers uses for the wizard who once owned him as a familiar.
```
````
