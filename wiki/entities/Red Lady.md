...
sources:
  - "campaign-os:red-lady-narration-appearance.md"
  - "campaign-os:red-lady.md"
created: 2026-09-13
updated: 2026-09-13
type: npc
lifecycle: proposed
...
![[red-lady-narration-appearance]]

A two-masted, privateer-rigged brigantine built by the [[Chain Council]], 96 feet long. Craftsmen stained her hull deep red in the wood rather than painting it, uniform and deliberate from waterline to rail. Gun decks with seven cannon ports per side, plus swivel mounts fore and aft, made her lethal. She could sail alone for months, fast enough to flee and armed enough to fight any opponent. The *Red Lady* was in perfect condition when she sank.
...
| **Facility Space** | 8 / 8 units (Tier 2 cap, pre-wreck) |

**Facilities (pre-wreck).**

- Captain's cabin: chart table, iron lockbox (private access to the magazine key).

- Signal station: flags, lamps, drum signals, code books. Fleet coordination platform.

- Fleet Intelligence Room with encoded logs, cipher keys, and contract archives (2 units).

- Navigator's station with full chart library: [[Midchain]] routes, Strait approaches, Scatter anchorages, partial Maw bathymetry.

- Surgeon's berth: stocked for combat casualties and extended voyages.

- Below-waterline magazine with boarding kit: powder, weapons, shot, and match.
...
[[Delmar Fisk]] served as Admiral (survivor). [[Rael Corven]] served as flag captain. [[Crissdalynn Khinriss]] served as navigator and crow (survivor). Every new hand went through Rael's training program before touching a line in action. The ship's reputation as the best-run vessel in the fleet came directly from how he ran it.

## Connections

- [[Fisk's Fleet]]: the broader fleet that sank with her

- [[Chain Council]]: built the ship

- [[Pearl of Souls]]: went down aboard her (active Maw Pearl Crisis)

- [[Umberlee]]: sank the fleet in retribution

- [[The Dead Lady]]: Umberlee's spectral duplicate of this ship, raised as pressure on [[Delmar Fisk|Fisk]]

- [[Batta Zusto]]: accessible broker on the salvage commission racing to reach the wreck

- [[Savia Brentino]]: has turned away suspicious enquiries tied to the commission

- [[Serafina Windfall Fisk]]: wife of Delmar Fisk, not aboard when the ship went down

- [[The Tangle]]: has noticed the money moving toward the wreck
