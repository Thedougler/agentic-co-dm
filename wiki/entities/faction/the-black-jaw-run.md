...
- They offer shelter, forged documents, messages, and route access through the Passage.
...
**Next work.** Continue the Run's existing work through Nona's anchor, its couriers, and its Passage connections.
...
**Player opening.** The party can answer Perrin's favor or protect the Warren. They can also carry a message or help the Run sabotage a Crown operation.
...
**Why.** Perrin found Nona in Session 03, and she called off the attacks once she learned he was not captured.
...
| Situation | Run it |
| --- | --- |
| **When encountered** | Members are moving goods or messages. They may be sheltering someone or forging papers. They may also be checking whether a contact can be trusted. |
...
| **When broken** | The Warren may remain as a place, but the Run loses the trust and routes that let it shelter, move, and defend people. ^[inferred] |

## History

- **Session 03** (`vault/episodes/003/`). Perrin found Nona. She called off the attacks once she learned he was not captured, he accepted an unspecified favor, and he received a sending stone.
- **Source status.** The session log shows the faction in actual play. The citation above is a primary transcript line.
