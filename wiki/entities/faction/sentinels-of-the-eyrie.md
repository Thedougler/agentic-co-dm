...
summary: "Aarakocra monks at High Eyrie watch and record the Drowned Maw. Their schism created a breakaway order."
provenance:
  extracted: 0.9
  inferred: 0.05
  ambiguous: 0.05
...
| | |
| --- | --- |
| **Nature** | Aarakocra monastic order. |
| **Scope** | High Eyrie and the Drowned Maw. |
| **Base** | [[high-eyrie]] |
| **Leader** | [[master-kyzil]], senior master. |
| **Public purpose** | Watch the [[drowned-maw]] and maintain a continuous record. |
...
| --- | --- | --- | --- | --- |
| Observation ledgers | Information | [[high-eyrie]] | Continuous records of the Maw since 1295 DR. | Maintained |
| Monastic training | Force | [[high-eyrie]] | Landing, moving, and holding still in peak wind. | Active |
| Pilgrimage routes | Access | High Eyrie and the Maw | Controlled approaches to the order and its watch. | Guarded |
| Founding documents | Information | Beneath [[high-eyrie]] | Evidence tied to the seal and Soul Incarnate. | Guarded |
...
| --- | --- | --- | --- |
| [[high-eyrie]] | Headquarters / Strong | The watch, ledgers, training, and founding documents. | Access is physical and social. |
| [[drowned-maw]] | Watching / Hidden | Continuous observation of time, weather, position, water, and occurrence. | The order refuses to dive or intervene. |
...
| Situation | Run it |
| --- | --- |
| **When encountered** | Apprentices train on the exposed terraces while record-keepers write the latest Maw observations. |
