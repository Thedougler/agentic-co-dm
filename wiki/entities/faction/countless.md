...
| | |
| --- | --- |
| **Nature** | Breakaway order from the [[sentinels-of-the-eyrie]] |
| **Scope** | Midchain pilgrim routes and Sentinel waystations |
| **Base** | Covert routes, grey markets, and Sentinel waystations |
| **Leader** | [[talon-vantyrus]] |
| **Public purpose** | Operate outside Sentinel discipline while pursuing Fate Spinner carriers |
...
| Faction / person | Stance | What Countless wants from them | Leverage, debt, or friction |
| --- | --- | --- | --- |
| [[sentinels-of-the-eyrie]] | Rival | Access to their routes, visitors, and Fate Spinner carriers | The Countless are breakaways from the order |
