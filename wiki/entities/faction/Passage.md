...
summary: Rescue and smuggling network that moves people off official routes, with Nona as the face and a law against treating people as cargo.
provenance:
  extracted: 0.85
  inferred: 0.10
  ambiguous: 0.05
...
> **DM thesis:** The Passage keeps communities alive under colonial paperwork by moving people first and answering questions later.
```
...
- **They want:** A workable route, proof they can trust, and help recovering people already taken.
- **They offer:** Safe kitchens, courier access, ships, and a name that opens other kitchens.
- **They pressure with:** Favors that become obligations, and the choice to refuse them.
- **They will not:** Move people as property.
- **Their tell:** They reroute the body before they answer the question.
```
````
...
**If leadership disappears:** The source does not establish a successor beyond the family courier net.
