...
> [!mechanic]
> **Stage Crew** *(DEX/STR/WIS)*. DEX Acrobatics for rigging dramatic entrances and dangerous stage business. STR Athletics for hauling props and building crowd-visible spectacle. WIS Perception DC 13 to time a cue at the exact right moment (success gives advantage to that phase's Performer check). INT (Arcana or tools) to operate alchemical or mechanical effects. A failed check rolls on the Complication table.

Support roles work in parallel with the Performer: one specialist per role per phase.
...
> [!mechanic]
> **Phase 1 - La Prova.** DC 12 per role check. Need 2 successes from available roles.
> **Pass:** establishes a crowd base. Rival bands take note.
> **Fail:** crowd is polite but unconvinced. The performers lose the opening Insight bonus (they don't know what this crowd wants yet).

> [!check] Insight — Reading La Canzone Nera's "Advice"
> DC 13. La Canzone Nera sends a representative to "offer advice" (actually fishing for the performers' weakest link).
...
> [!mechanic]
> **Phase 2 - La Sfida.** DC 14 per role check (Performance for Performer, the relevant skill for Stage Crew or Crowd Work as listed above). Need 3 successes from available roles.
> **Pass:** +2 to all Phase 3 checks. One rival band is visibly struggling.
> **Fail:** entering the finale as underdogs (recoverable). The Performer gets one "all-in" option in Phase 3.

Rival disruptions (the performers can counter one per phase; others land):

> [!check] Investigation — Who Sabotaged the Stage Crew
> DC 15. La Canzone Nera bribes the [[Mercatura]] stage platform crew. On a failed Stage Crew check, a prop fails or lighting cuts out.
> **Success:** discovers who arranged it.
> **Failure:** the sabotage's source stays hidden.

> [!check] Crowd Work — Countering Il Vento di Seta's Blocked Sightlines
> DC 14. Il Vento di Seta poaches the best viewing spot on the [[Velo Quarter]] bridge, blocking sightlines.
> **Success:** redirects the crowd via the [[Le Paludi]] waterfront instead.
> **Failure:** the blocked sightlines cost the performers the [[Velo Quarter]] crowd.

> [!check] Crowd Work/Athletics — Intercepting Le Ossa del Toro's Surge
> DC 13 Crowd Work to intercept, or DC 14 STR to physically redirect the surge. Le Ossa del Toro starts a crowd surge toward the waterfront.
...
> [!mechanic]
> **Phase 3 - Il Grande Finale.** DC 16 per role check (Performance for Performer, the relevant skill for Stage Crew or Crowd Work as listed above). A failed check contributes no success toward the 3-of-4 needed this phase.

Any performer may declare All-In once per finale for advantage, but a failed All-In attempt rolls 1d6 for complications (usable once per group).

> [!mechanic]
> **All-In complications.** Roll 1d6 for complications. On a 1: pyrotechnics misfire (next Performance check at disadvantage). On a 2: an instrument breaks (automatic -1 failure this phase). On a 3: a crowd member climbs onstage (manage as bonus action or checks at -2). On a 4: a rival fan starts a chant (Persuasion DC 15 to shut it down). On a 5: rain starts (Stage Crew DC 14 or lighting rig fails). On a 6: nothing bad happens (the crowd thinks you planned it). The group gains +1 success this phase.
...
- **Prospero Morsani's Cabinet** - [[Morsani]] will not perform himself, but for the right question will lend a single prop from the locked wardrobe cabinet. The prop produces a spectacular visual effect usable once during the Grande Finale (treat as an automatic success on one Stage Crew check). He will not explain the prop beforehand. Both are appropriate and strange.
