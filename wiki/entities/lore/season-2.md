...
sources: ["season-02-arc.md"]
summary: "Open Midchain sandbox from level 5 to 10: unofficial piracy, island hooks, and live clocks rather than a rail."
provenance:
  extracted: 1.0
  inferred: 0.0
  ambiguous: 0.0
...
* **Players notice:** Dock gossip, island hooks, and clocks that fill whether they chase them or not.
* **This enables:** Choosing a stop without a rail.
* **This warns of:** Karath is too hot early. The Blight is not this season's fight.
