...
kind: doctrine
truth: established
scope: "Grung body color, social role, and Gold-caste censure."
region: "Shattered Sea"
era: current
summary: "Grung color and the sealing rite signal role and censure; Twiceborn names Gold's sanctioned censure status."
provenance:
  extracted: 1.0
  inferred: 0.0
  ambiguous: 0.0
...
A Grung eats and then seals the diet into the body through a daily one-hour soak. The resulting color currently carried by the body signals social role and censure, but it does not by itself prove ancestry, virtue, or permanent rank.
...
* **Exception.** Color alone does not prove ancestry, virtue, or permanent rank.
* **Unknown.** The exact diet chemistry, sealing words, and full process remain unknown.
...
**Misunderstood.** The party may mistake color for permanent rank; no party belief is established.
...
> Color tells the room what the body has been made to carry; it does not tell the room what the Grung deserves.
...
* [ ] **Decide when needed.** Whether a particular color can be forged or counterfeited can remain fluid until play tests it.
