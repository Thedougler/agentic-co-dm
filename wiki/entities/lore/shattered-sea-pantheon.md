...
kind: cosmology
truth: partial
scope: "The Shattered Sea and the peoples, ports, and institutions that worship there"
region: "Shattered Sea"
era: "Current campaign"
summary: "The Shattered Sea's divine practice centers on Umberlee at sea, with Valkur, Tyr, and a separate Aarakocra sky-pantheon shaping local observance."
provenance:
  extracted: 0.85
  inferred: 0.10
  ambiguous: 0.05
...
**Scope.** This is a regional practice index, not a claim that every port or worshipper understands the gods in the same way.
...
**Known.** The regional index records the public roles described above; no party-specific discovery is recorded here.

**Suspected.** Individual patron claims may fail, go silent, or be tested.

**Misunderstood.** Do not assume this index establishes direct divine appearances.

**Last changed.** No session is recorded as changing this regional index.

---

## Common telling

> Pay the sea, keep your word, and know who is watching the sky. The rest is argument for people safely ashore.
...
* **Because this is true,** religious language can function as contract, payment, or civic authority.
* **If exposed,** a failed patron claim could change how a port treats its clergy and institutions.
* **If disproved,** a community's account of its patron may split from the regional practice.
* **If changed,** [[sin-and-sanctuary]] becomes a live source of campaign pressure.
* **If exploited,** a false oath or manipulated tribute can redirect institutional power without changing anyone's theology.
