...
sources:
  - "Blackrule.md"
  - "wiki/entities/place/Blackrule.md"
  - "wiki/entities/npc/aleksander-malone.md"
  - "wiki/entities/npc/corvin-ashe.md"
summary: "Tyr is a deity named on Blackrule's altar and treated as patron by Crown heresy hunters; the extent of Tyr's doctrine and current warnings remains partial."
provenance:
  extracted: 0.9
  inferred: 0.1
  ambiguous: 0.0
tier: supporting
created: 2026-09-13T07:15:00Z
updated: 2026-09-20
type: lore
reveal: unrevealed
...
kind: doctrine
truth: partial
scope: "Blackrule, Sorrowbell, and Tyr's known servants in the Dravosi Crown"
region: "Midchain"
...
* **Exception.** Tyr's relationship with individual servants is not uniform: Malone acts as a confirmed-heresy hunter, while Ashe has lost access to Tyr's warnings.
* **Unknown.** The source does not establish what Tyr requires beyond the language of heresy, warning, and protection.
* **Impossible or forbidden.** Do not treat Crown claims about Tyr as proof that every accusation of heresy is true.

## At the Table

* **Players notice.** Tyr's scales are cut into the altar stone at Blackrule; Sorrowbell's Tyr box is empty when the demon arrives.
* **This explains.** It explains why Malone leaves Blackrule only for confirmed heresy and why Ashe invokes Tyr while scapegoating the woods coven.
* **This enables.** The party can compare a servant's claim with the physical signs at Blackrule or Sorrowbell instead of accepting religious authority at face value.
* **This warns of.** A Crown servant who declares heresy may have institutional power even when Tyr's actual warnings or protection are absent.
* **Relevant now.** The Hound of God thread and Penance Bar's failed sanctuary both turn Tyr's authority into immediate pressure.
...
**Known.** No player-facing knowledge is established on this page; the lore remains unrevealed.

**Suspected.** The party may suspect Tyr's authority is not identical to Crown claims after the Sorrowbell confrontation.
...
> “When Tyr confirms the heresy, the Hound goes.”

No broader common telling, liturgy, or teaching is established.
...
* **Because this is true,** Blackrule can serve as a religious training house and a source of Crown heresy pressure.
* **If exposed,** Ashe's inability to hear Tyr's warnings undermines his public authority.
* **If disproved,** Malone's mandate and the Crown's heresy machinery lose their religious justification.
* **If changed,** [[aleksander-malone|Aleksander Malone]] and [[corvin-ashe|Corvin Ashe]] would need different grounds for their actions.
* **If exploited,** the party can force a distinction between what Tyr communicates and what Crown servants claim.
...
* [ ] **Decide when needed.** Whether Tyr's scales, warnings, and protection are literal divine action or an in-world religious interpretation.
