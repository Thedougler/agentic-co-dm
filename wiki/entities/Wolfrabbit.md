...
> [!narration] Narration
> A dark-striped hunting cat crouches over the boat, its enormous ears pricked above a broad, furred head. Red eyes track you through the terrace brush, a twitching nose wet with saliva, and hooked claws grip the rim. Wolf-sized and built to spring, it can cross the gap before the boat clears the bank.
...
- **Diet.** They avoid [[Aruhe - Razer-Grass]], break a pounce for the smell of a mature [[Aruhe - Grubnade|Grubnade]], and drive prey toward [[Snakewood]] strike-lanes.
...
- **Instincts.** The pack isolates anything bleeding, knocks it down with a long bound, and closes around a creature that has lost its footing. It avoids razer-grass and abandons a pounce when it smells a mature Grubnade.
...
- **Weaknesses.** Pack Rend is lost when a Wolfrabbit is separated from its pack, and its pounce is easier to deny in tight spaces or against a creature that holds its ground. Razer-Grass, mature Grubnades, and broken launch lines turn its preferred approach into a liability.
