...
Umberlee named the Pearl as her price after reading Delmar's offer out of his head. Catarina Da'Virelli gave him Lamarae's Fang. He is aboard *[[Uncertainty]]* at [[aruhe]]. See [[journal/sessions/shattered-sea/recaps/Session-04-Recap]] and [[story-so-far]].
...
| ----------- | ----- |
| AC          | 16 (leather) |
| HP max      | 38 (current 35) |
| Init        | +7 (Dexterity +5 plus Charisma +2 from Rakish Audacity) |
| PP          | 14 |
...
Mobile ranged and melee skirmisher — Sneak Attack (3d6) on the blunderbuss is the damage engine · AC 16 · HP 38 · Achilles heel is a solo alpha strike before his first turn.

### Counters & Synergy

- **Hard counters.** Grapples, restraint, and first-round alpha strikes that clear his hit points before he acts.
- **Soft counters.** Crowded spacing that denies Rakish Audacity geometry; social insults aimed at his crew.
- **Amplifies / Depends on.** Isolated targets for Rakish Audacity Sneak Attack. [[catarina-davirelli]] enchanted the blunderbuss mid-fight. [[crissdalynn-khinriss]] has already pulled him out of Admiral Fisk once.
...
| ------- | ------ | ------ | ---- | -------- |
| Sneak Attack | Rogue | Extra 3d6 with a Finesse or Ranged hit that has Advantage, or when an ally is within 5 ft of the target and Delmar does not have Disadvantage. Rakish Audacity also lets him Sneak Attack a creature within 5 ft if no other creatures are within 5 ft of him. | 1/turn | — |
| Cunning Action | Rogue | Bonus Action Dash, Disengage, or Hide. | — | — |
| Steady Aim | Rogue | Bonus Action Advantage on the next attack this turn if he has not moved; Speed becomes 0 until the end of the turn. | — | — |
| Cunning Strike | Rogue | When Sneak Attack damage lands, forgo 1d6 for Poison (Constitution save DC 16, needs a Poisoner's Kit), Trip (Dexterity save DC 16, Large or smaller → prone), or Withdraw (move up to half Speed with no Opportunity Attacks). | with Sneak Attack | — |
| Uncanny Dodge | Rogue | Reaction to halve damage from an attack he can see. | 1/reaction | — |
| Fancy Footwork | Swashbuckler | A melee attack on his turn stops that target's Opportunity Attacks against him for the rest of the turn. | — | — |
| Rakish Audacity | Swashbuckler | Add Charisma to Initiative; Sneak Attack geometry as above. | — | — |
| Firearm Specialist | Feat | Firearm proficiency. On a misfire, Reaction d20; higher than the misfire score prevents the misfire. | — | — |
| Lucky | Feat | Luck Points equal to Proficiency Bonus (3); spend on a D20 Test. | 3 | Long Rest |
| Tavern Brawler | Feat | Unarmed Strike can deal 1d4 plus Strength bludgeoning; reroll 1s on those damage dice. | — | — |
...
| Blunderbuss (Exandria) | — | Ranged; Sneak Attack engine | — | Enchanted mid-fight by Catarina |
| Pistols (Vex) | — | Ranged | — | 3 equipped plus one Foundry-named "Unknown thing." pistol |
| Daggers (Nick) | — | Melee / thrown | — | 2 equipped |
...
| Steady Aim | Has not moved this turn | Advantage on next attack; Speed 0 until end of turn | — | — |
...
| Feat | Source | Effect |
| ---- | ------ | ------ |
| Firearm Specialist | — | Firearm proficiency and misfire Reaction |
| Lucky | — | 3 Luck Points per Long Rest |
| Tavern Brawler | — | Improved Unarmed Strike |
...
| Item | Qty | Notes |
| ---- | --- | ----- |
| Leather armor | 1 | Equipped |
| Rapier (Vex) | 1 | Equipped |
| Daggers (Nick) | 2 | Equipped |
| Pistols (Vex) | 3 | Equipped |
| Unknown thing. (pistol, Vex) | 1 | Equipped; Foundry name is literal |
| Blunderbuss (Exandria) | 1 | Equipped |
| Bag of Holding | 1 | Equipped |
| Backpack | 1 | Equipped |
| Musket bullets | 40 | — |
| Blunderbuss bullets | 5 | — |
| Potion of Healing (Greater) | 1 | 4d4 + 4 HP |
