...
| --- | --- | --- | --- | --- |
| Sneak Attack | — | Extra `3d6` with a Finesse or Ranged hit that has Advantage, or when an ally is within 5 ft of the target and Delmar does not have Disadvantage. Rakish Audacity also lets him Sneak Attack a creature within 5 ft if no other creatures are within 5 ft of him. | 1/turn | — |
| Cunning Strike | — | When Sneak Attack damage lands, forgo 1d6 for Poison (Constitution save `DC 16`, needs a Poisoner's Kit), Trip (Dexterity save `DC 16`, Large or smaller → prone), or Withdraw (move up to half Speed with no Opportunity Attacks). | with Sneak Attack | — |
...
| Trait | Effect |
| --- | --- |
| Variant Human traits | Extra language, extra skill, bonus feat (spent on Lucky) |
