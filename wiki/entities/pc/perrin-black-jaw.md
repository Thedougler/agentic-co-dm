...
| Speed | 30 ft.; swim equal to walk (30 ft.) |
| Size | Small |
| Hit Dice | 2d8 (Warlock) + 3d8 (Bard) |
| Proficiency Bonus | +3 |
...
| --- | --- |
| Acrobatics | `+10`, expertise |
| Arcana | `+3`, proficient |
| History | `+3`, proficient |
| Insight | `+3`, proficient |
...
| --- | --- | --- | --- | --- |
| [[cure-wounds\|Cure Wounds]] | Bard spell slot | `1d8 + 5` healing by touch (`9` average) | One slot | The combatant transcription lists this as an Action |

### Bonus Actions

| Bonus Action | Trigger / Cost | Effect | Uses | Recovery |
| --- | --- | --- | --- | --- |
| Bardic Inspiration | Bonus Action | Grant a `1d6` die to a creature within `60 ft.` | `5` | Long Rest |
| Pact of the Blade | Bonus Action | Conjure or bond one touched melee weapon | — | — |
| [[healing-word\|Healing Word]] | Bard spell slot | Restore `1d4 + 5` HP (`7` average) to a creature within `60 ft.` | One slot | — |

### Reactions

| Reaction | Trigger | Effect | Uses | Recovery |
| --- | --- | --- | --- | --- |
| Cutting Words | A creature Perrin can see within `60 ft.` makes an attack roll, ability check, or damage roll | Spend a Bardic Inspiration die to subtract `1d6` from the roll | Shares Bardic Inspiration | Long Rest |
| Pack Tactics | An enemy hits an ally within `5 ft.` | Make one weapon attack against the creature that hit the ally | `3` | Short or Long Rest |
...
| [[hex\|Hex]] | 1st / Warlock | Adds extra necrotic damage on hits and imposes the curse's ability-check disadvantage |
| [[protection-from-evil-and-good\|Protection from Evil and Good]] | 1st / Warlock | Narrow creature-type-conditional defense |
| [[silent-image\|Silent Image]] | 1st / Bard | No default mechanical combat effect |
| [[invisibility\|Invisibility]] | 2nd / Bard | Grants invisibility to a touched creature |
| [[mirror-image\|Mirror Image]] | 2nd / Bard | Creates illusory duplicates that can absorb attacks |
...
| Trait | Source | Effect |
| --- | --- | --- |
| Keen Senses | [[rattkin\|Rattkin]] | Advantage on Perception checks relying on hearing or smell |
| Scurry | Rattkin | Disengaging lets him move through Large or smaller occupied spaces without Opportunity Attacks from those creatures |
| Survivor | Rattkin | Advantage on saves against poisoned and disease; resistance to poison damage |
| Rattkin Variety (Swimmer) | Rattkin | Swim speed equals walking speed |
| Boneless | Rattkin | Treat spaces as Tiny at half Speed; advantage to escape Grapple or Restrained |
| Pack Tactics | Rattkin | When a creature he can see within `5 ft.` is hit by another creature, the Pack Tactics reaction can make one weapon attack; `3` uses per Short or Long Rest |
| The Small | Mortis | Disadvantage on Strength checks and saves; `+2` Charisma; makes hard ship labor a poor fit |

### Class Features

| Feature | Source | Effect | Uses | Recovery |
| --- | --- | --- | --- | --- |
| Expertise | [[bard\|Bard]] | Double the bonus to Acrobatics and Persuasion | — | — |
...
| --- | --- |
| [[nona-black-jaw\|Nona Black-Jaw]] | Grandmother and sending-stone contact; she gave him an open favor and he owes her the [[survey-aruhe-as-a-tangle-anchor\|Aruhe survey]]. She knows he is alive but not the full Vestra loss, and he has stopped reaching out. |
| [[rattkin-runs-and-black-jaw-run\|Rattkin Runs and Black-Jaw Run]] · [[Passage]] | Family and rescue network. Perrin is loyal to his Run rather than to Rattkin generally. |
| [[vestra\|Vestra]] | Black-Jaw family heirloom built and captained by his grandfather Vincenzo; it was lost to something massive from deep below, costing money and likely crew. The chase and vengeance remain partly unshared, and a surviving crew member could bring relief wrapped in guilt. |
| [[uncertainty\|Uncertainty]] | Home ship, renamed from the Surety under a borrowed name while approaching Calveno; the crew is now aboard at [[aruhe\|Aruhe]]. |
| [[crissdalynn-khinriss\|Crissdalynn Khinriss]] | Trusted crew member whose avian form triggers Perrin's natural fear response; she stopped him from killing Ket. |
| [[delmar-fisk\|Delmar Fisk]] | Crew member who received Perrin's Boots of Flying; Perrin backs him with Healing Word and shared a silent look with him during the Vestra confession. |
| [[jean-claude-tabarnack\|Jean-Claude Tabarnack]] | Crew member and sewer-scouting partner; their conflicting family loyalties could be pulled by the same slaver bargain. |
| [[cobb\|Cobb]] | Old contact met at La Vasca on arrival in Calveno. |
| [[master-kyzil\|Master Kyzil]] | Called Perrin's drum a tactical threat during the spar; removing Perrin or the drum cuts the party's Bardic Inspiration multiplier. |
| [[the-tangle\|The Tangle]] | Perrin wants to support his family and become an elder who teaches young Rattkin to move through the Dry without being killed. |
| [[warren\|The Warren]] | Full detail of Nona's Aruhe-anchor commission is kept there; no session file confirms the commission yet. |
| [[auralis\|Auralis]] | The hidden patron connection changes what Perrin's survival and Warlock pact mean, although Perrin does not know Auralis's role. |
| [[leviathan\|Leviathan]] | The working explanation for what destroyed the Vestra remains unresolved at medium confidence. |
| Dravosi bounties | Rattkin bounties remain real, rarely enforced background pressure. |

> [!secret]- Campaign Truths
> [[auralis\|Auralis]] actually kept Perrin alive after the Vestra wreck and forged an unwitting Warlock pact with him. Perrin credits the old Manta Ray cloak instead, and that mistaken belief remains separate from the unresolved cause of the wreck.
> Perrin's drive is vengeance against whatever destroyed the Vestra, while he misses fishing and keeps limited trust for dry-landers. His prey response appears when badly frightened. He will not traffic people, but manipulation, bribery, and blackmail remain available tools; he does not mistreat people who cannot fight back and instead loses interest in them.
> A faction can offer to free slaves in exchange for betraying a Rattkin ally, placing Jean-Claude's terminal node against Perrin's family loyalty. The chase may become more important than the Run hierarchy, and Perrin may put his family in the path of vengeance to pursue it.
