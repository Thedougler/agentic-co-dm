...
title: "Terror-Birds"
category: entities
tags: ["shattered-sea", "creature", "horror", "exploration"]
sources:
...
visibility: dm
summary: "Blight-corrupted axebeak variant scaled to apex predator on Aruhe, solitary ambush hunter that swallows horses whole and announces its charge through the ground."
provenance:
  extracted: 0.85
  inferred: 0.10
  ambiguous: 0.05
...
**Enormous black predatory bird towering over a horse**, wingspan filling the canopy even folded. The beak is massive, serrated inside with visible teeth. Moss and green vegetation grow directly from its feathers and wings, the [[Blight|Blight's]] corruption made physical, [[Aruhe]] claiming even its apex predators. Yellow piercing eye. Clawed feet built like a hunting bird's, each talon the length of a forearm. A corrupted prehistoric predator.

The ground shakes before you see one.
...
**The moss and vegetation growing from its feathers is not decoration.** The island is reclaiming the bird the same way it reclaimed the terraces, and the bird does not seem to notice or mind. It has been growing for decades, possibly longer. No one has counted how many there are, because counting requires getting close enough to see one before it sees you.

Home zones: [[the Rot]] to [[the Hunger]]. Deep-interior predator only. The party encounters them in the inner jungle and the approach to the central grove.
