...
For this 5th-level spell scroll, the spell uses a saving throw DC of **17** and has an attack bonus of **+9**.

This scroll holds a single casting of [[Scrying]]. A scroll like this doesn't come cheap, and it doesn't come common. It's exactly what people watching a newly-famous crew already own themselves. Better the crew has one too.

## Mechanics

> [!mechanic] Scrying (5th-level scroll)
> [RAW] Casting Scrying from this scroll forces the target to make a [[Wisdom]] saving throw against DC 17. On a failed save, an invisible sensor appears near the target, and the caster sees and hears through it for the spell's duration. On a success, the target resists the spell, and the caster can't target it again for 24 hours. A picture, possession, or body part from the target improves the odds, exactly as the spell text specifies.

## Provenance

A salvaged hull's strongbox held this scroll, its wax seal still intact. It now sits among the other unclaimed prize-goods on [[Vask's Reclaimed Goods]]'s shelves.
