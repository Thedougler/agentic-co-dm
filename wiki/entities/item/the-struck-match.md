---
title: "The Struck Match"
aliases:
  - The Struck Match
category: entities
tags: [shattered-sea, item]
sources:
  - "campaign-os:the-struck-match.md"
created: 2026-09-13
updated: 2026-09-13
type: item
lifecycle: proposed
...
> [!narration] Narration
> The roll is short and plain, the paper bare of wax, and one tip carries a grey head the size of a peppercorn.
>
> Drag the head along the counter and it catches on its own, no taper needed, with a snap like a knuckle cracking.
>
> The first breath tastes of flint and cold iron, thin all the way down.
>
> The ember settles to a steady orange and stays there, holding its size while the room's lamps gutter.


*Consumable, Uncommon.*

One of the blends [[rufio-segalla]] keeps on the shelf at [[La Brace]], named for the only thing it does.
...
The hour runs from that first breath, fight or no fight. Lighting the cigarette spends it, and a second one smoked inside the hour extends nothing and grants nothing.
...
**Limitations:** this blend moves nothing on the sheet. Attack rolls, damage rolls, saving throws, and AC all stay where they were, and surprise works exactly as it would have. Smoking two at once buys no longer window than smoking one.

## Provenance

[[rufio-segalla]] finishes every blend himself in [[La Brace]]'s back room. He buys the base compound by standing order from [[marta-orsini]] at [[Studio Orsini]] in [[le-paludi]]. The striking heads are his own addition, mixed so a customer walking into trouble never has to ask anyone for a light.
