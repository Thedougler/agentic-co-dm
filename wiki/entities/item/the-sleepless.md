...
> [!narration] Narration
> The roll has gone brown at both ends, cured past the colour paper should reach, and the twist at the tip is somebody's hurried work.
>
> It rattles faintly when you turn it. The leaf inside has dried to grit and shifts against the wrapper.
>
> The first breath is bitter enough to close the back of your throat, and it stays bitter.
>
> The ember refuses to bank. Set it down and it goes on burning at the same hard orange, eating through the roll with nobody's mouth on it.


*Consumable, Uncommon.*

A batch [[Studio Orsini]] left on the drying racks four days too long, sold under [[the Bridge]] by the tin.
...
The hour runs from that first breath and burns through a quiet afternoon exactly as fast. A second cigarette smoked inside the hour extends nothing and stacks nothing.
...
**Limitations:** it moves nothing else on the sheet, and it does not end an effect the smoker is already under. A creature charmed or frightened when the match strikes stays charmed or frightened.
