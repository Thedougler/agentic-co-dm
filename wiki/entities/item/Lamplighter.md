...
visibility: dm
summary: "A consumable arrow that coats its target in cold luminous rot, making it glow for an hour and unable to hide, with the glow visible from 300 feet in darkness."
provenance:
  extracted: 0.85
  inferred: 0.10
  ambiguous: 0.05
...
> [!narration] Narration
> A light arrow with a glass head, blown thin and blue, full of something that moves slowly when you tilt it.
>
> Whatever is in there glows pale green, casting enough light to read a hand by.
>
> No heat comes off it at all. Through the glass the shaft looks wet.
>
> Waxed thread wraps the glass once, a break-line built to come apart cleanly.
>
...
>
> **Edge cases:** a miss or a hit against an object still breaks the head. Whatever it struck, anywhere from a door to a mooring post, glows for the same hour. Ooze, water, and slime-bodied creatures shed the coating in 1 round. A creature already glowing gains nothing further from a second arrow.
>
> **Limitations:** it grants no advantage on attack rolls against the marked creature and deals no ongoing damage. It does not burn, and it neither reveals a creature standing behind a wall nor follows one through a door you cannot see through. It marks. Everything after that is legwork.
