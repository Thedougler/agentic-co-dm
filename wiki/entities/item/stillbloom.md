...
- **Appearance.** A dull, four-foot waxy stalk grows where green first goes black at the leaf edge. Pale hollow bracts end in dark needles. After years underground, a mature stalk raises one enormous cream-white flower with a faint green center, then dies.
- **Behavior.** Stillbloom reads vibration rather than malice. Rain, a falling leaf, a mouse, and a careful footstep do not trigger it. Scavengers move slowly across the shallow root mat and feed on what the soil brings down.
- **Trigger.** A charged mature stalk fires when a Small or larger grounded creature within 20 feet moves more than 10 feet on its turn, Dashes, jumps, falls, is forcibly moved 10 feet or more, or makes another violent motion. Moving 10 feet or less on a turn is safe, as is flying without touching the root mat.
- **Notice.** A DC 14 Wisdom (Perception) check notices launch-spines, punctured carcasses, and odd scavenger paths. A DC 14 Intelligence (Nature) or Wisdom (Survival) check recognizes the root vibration and reveals that slow movement is safe. After 1 minute of watching scavengers, the pattern becomes clear without a roll.
- **Volley.** Each creature within 15 feet of the plant makes a DC 14 Dexterity saving throw. On a failure, it takes 2d6 piercing damage, one spine embeds, and it gains 1 Exposure. On a success, it takes no damage.
