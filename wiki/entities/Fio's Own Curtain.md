...
| Field | Detail |
|---|---|
| `one_thing` | Hung in a doorway, it hides everything behind it from outside eyes. |
| `rarity_justification` | Uncommon: functional stock, priced at the Uncommon band. |
| `attunement_reason` | None. No roll bonus, one power. |
| `pc_connection` | Gives [[Jean-Claude Tabarnack|Jean-Claude]] a doorway nobody reads. |
| `current_holder` | [[Fioravante Selmerin|Fio]], hung in the front window. |
| `narrative_hook` | Bought for 200 gp, or borrowed off the window rod. |
