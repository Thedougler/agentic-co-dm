...
visibility: dm
summary: "A secret mystical sect threading through Dravosi and Tessarine noble courts, growing through miraculous healings that bind grateful hosts as unwitting phylacteries."
provenance:
  extracted: 0.85
  inferred: 0.10
  ambiguous: 0.05
...
*A secret mystical sect threading through noble courts, built on miraculous healings and bound phylacteries.*
...
**Doctrine:** body and spirit are one path through mortality. The Turning (dance, song, fasting, confession, flagellation) brings visions, healings, and altered states through collective fervor.

**Leadership:**

- Shepherd Grigori is the sole named shepherd and only visible power.
- Internally he is *Korabl*, the Ship, the vessel that carries the divine through the mortal world.
- No second-in-command exists. The sect loses coherence by design the moment Grigori falls.
- No formal roster or hierarchy exists beyond him.
...
Agenda, per the source: grow the flock one healing at a time. The source names no goal beyond this steady growth.

### Front: The Army, Not the Heir
...
**Off-screen move if unopposed:** reaches a new noble court and heals another dying heir before anyone can ask questions. One more grateful household.

**Trigger conditions:**

- Every successful healing-and-binding advances this front; every renewal visit sustains a thread that would otherwise dilute out.

**Clock:** 6 segments (slow burn), filled 2 (a Tessarine ward in Calveno, a Dravosi merchant-lord's daughter)

**Consequence at fill:** the network reaches critical mass. Grigori shifts from patient accumulation to active use, steering votes and marriages through threads no one has traced.
...
**Three-Clue Trail:** see Shepherd Grigori § Investigation for the three seeded clues, since this front adds no new gate of its own.
