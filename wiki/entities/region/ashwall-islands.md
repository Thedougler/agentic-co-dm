...
visibility: dm
region: "west of the Shattered Sea"
scale: regional
kind: archipelago
structure: routes
as_of: ""
...
> [!narration] Narration
> Cold-water volcanic spires rise from dark sea, their black stone cut by steam vents and warm cave mouths. Sulfur and salt hang over wreckage in the lee. Surf and vent-hiss carry between the cliffs, where the caves make the last solid shelter heading west and the first safe lee returning east.
...
| **Kind**          | Volcanic archipelago.                                          |
| **Character**     | Cold spires, hot vents, wreck salvage, and uncertain rescue.   |
| **Anchor**        | The Ashwall lee and its warm vent caves.                       |
| **Known for**     | Being the last solid ground westbound and first safe lee eastbound. |
| **Feared for**    | Wreck hazards, occupied fissures, sulfur vents, and storm gaps. |
| **Parent region** | [[shattered-sea]]                                             |

> **DM thesis.** The Ashwall Islands turn a passage into a choice between shelter and exposure. The lee offers repair water and warm caves, while wreckage, occupied fissures, and disputed rescue stories make every landing worth investigating.
...
* **Opportunity.** The lee provides shelter, repair water, and salvage.
* **Next visible change.** A lateral lightning branch through ash will signal an [[arclight-phoenix]] hatch.

## Regional truths

* The lee is warm enough for repair crews to work despite the cold sea air.
* Giant bats, giant scorpions, and giant vultures occupy the volcanic slopes and vent caves.
* Lateral fire that branches through ash and holds for a breath is the pilot families' hatch sign.
...
| --------- | --------- | ---------------- | ------------ |
| Ashwall lee | Sheltered repair water beneath the spires. | Wreckage and apparent rescuers make landings uncertain. | Repair, shelter, and salvage. |
| Warm vent caves | Steam-warmed fissures in black volcanic stone. | Giant bats and giant scorpions occupy the fissures. | Shelter from cold sea air, at the cost of entering occupied dark. |

### Landmarks

* **Ashwall spires.** The black volcanic towers are visible navigation marks and the region's unmistakable horizon.
* **Warm vent caves.** Steam vents and cave mouths offer warmth and shelter in the lee.
* **Wreck-strewn lee.** Wreckage marks the repair water and makes salvage possible.

## Travel

### Structure

* **Map.** No region map is established.
* **Travel structure.** Known sea routes between the Galewall, Ashwalls, the Crown Islands, the central strait, and the Midchain.
* **Scale.** No regional travel scale is established.
* **Procedure.** No formal regional travel procedure is established.
* **Navigation.** The spires and their steam vents provide visible marks; storm gaps and cold water complicate the approach.
* **Weather / season.** Cold sea air and storm weather routinely alter the crossing.
* **Rest / supply.** The lee and warm vent caves provide the region's established shelter; repair crews work there.
* **Regional rule.** No unusual regional rule is established.
...
No hidden or broken connection is established. The region's known routes are the westbound Galewall approach and the eastbound return through the lee.

## Key places

| Place | Kind | Current state | What it offers or threatens | Lead |
| ----- | ---- | ------------- | --------------------------- | ---- |
| Ashwall lee | Sheltered water | Repair crews and pilot families work here. | Shelter, repair, salvage, and uncertain rescue. | Wreckage identifies the lee from the water. |
| Warm vent caves | Volcanic caves | Giant bats and giant scorpions occupy the fissures. | Warm shelter and dangerous occupied dark. | Steam and warm cave mouths mark the entrances. |

## Active powers

| Power | Hold / presence | Wants now | Next move | What reveals that move |
| ----- | --------------- | --------- | --------- | ---------------------- |
| Ashwall pilot families | They keep practical sign logs in the lee. | Safe navigation and useful repair water. | Continue recording weather and hatch signs. | Pilot log books and spoken route advice. |

## Fronts and pressures

## Front or threat

* **Impulse / goal.** The permanent storm belt remains the last weather belonging to the charted homelands.

* **Impending consequence.** A crossing remains dangerous; a good pilot takes about three weeks and roughly one ship in three does not finish.

* **Affected.** Westbound routes approaching the Ashwall Islands.

* **Signals.** Stacked storm bands, rough crossing weather, and ships failing to return from the western approach.

* [ ] **Portent 1.** The storm belt blocks an easy westbound approach.

* [ ] **Portent 2.** A ship fails to complete the crossing.

* [ ] **Portent 3.** No further escalation is established.
...
**Encounter procedure:** No formal encounter procedure is established.

| d6 | Encounter | Sign / track / warning | Source or destination |
| -: | --------- | --------------------- | --------------------- |
| 1 | Giant bat in a vent cave | Wingbeats, guano, and movement in warm dark. | Warm vent caves |
| 2 | Giant scorpion in a fissure | A handhold leads into occupied dark. | Warm vent caves |
| 3 | Giant vulture over wreckage | A large shadow circles the cliffs after a wreck. | Wreck-strewn lee |
| 4 | Repair crew at work | Two hands watch one fouled spar or damaged fitting. | Ashwall lee |
| 5 | [[giant-owl]] watching from a highland | The owl stays still on one point for several minutes. | Ashwall highlands |
| 6 | [[arclight-phoenix]] hatch sign | Lateral fire branches through ash and holds for a breath. | Volcanic vents |

### Regional signs

* **Vent creatures.** Guano, wingbeats, claw marks, and movement inside warm fissures warn of giant bats and giant scorpions.
* **Wreck salvage.** Wreckage in the lee marks sheltered repair water and attracts giant vultures.
* **Arclight phoenix.** Lateral lightning through ash signals a hatch.
...
| ---- | ------ | ----- | ------------------------ |
|  | No later regional change is established. |  | [[Ashwall Islands]] |
