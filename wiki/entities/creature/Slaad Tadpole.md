...
|---|---|---|---|
| Hit a cluster with an AoE (Thunder Wave, fire, etc.) | Several tadpoles are grouped together | Most drop outright at 10 HP each, but one can shrug it off on a [[Constitution]] save and stay put | [[Catarina Da'Virelli|Catarina]] cleared a cluster this way against [[Otar the Foul|Otar]]'s brood in Session 07 |
