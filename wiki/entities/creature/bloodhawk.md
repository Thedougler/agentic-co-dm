...
aliases: [Bloodhawk, Aruhe - Bloodhawk]
sources:
...
- **Habitat.** Bloodhawks own the open sky above [[aruhe]], especially sea channels, lake bowls, reef gaps, river mouths, cliff faces, canopy breaks, and grassland rims.
...
- **Diet.** Whales are preferred coastal prey. Inland adults take [[bear-elk|Bear-Elk]], [[terror-bird|terror-birds]], large reptiles, and anything flushed into the open. Canoes and small boats count as prey.
