...
summary: "Rattkin settlement and deepest [[Passage]] anchor beneath Calveno; feels communal, hidden, and taught by elders."
provenance:
  extracted: 1.0
  inferred: 0.0
  ambiguous: 0.0
...
- **Conflict:** Passage protects communities under colonial pressure while Grung activity, Crown attention, and old fractures threaten the network.
- **Promise:** Earn a route, learn what a witness knows, and decide what safety can be shared.
...
## Senses
- **Sight:** low passages, stored bundles, hand marks, people moving quietly.
...
- **Retreat:** teaching node or known safe kitchen.
...
- **Document/symbol:** coded trust mark or teaching pattern (**seed**).
- **Failure cost:** route withheld, escort required, or witness moved—not clue erased.
## Pressure
Quiet → Alert → Contested → Transformed: normal refuge → watchers/changed teaching → route dispute → anchor moves or becomes public.
## Location moves
**Move:** elders relocate a teaching after exposed mark/pursuit; familiar node loses certainty; follow the lesson’s physical pattern; shortcut now requires trust.
...
- **Return state:** update who is sheltered, which route is taught, supplies, watchers, and next offer.
