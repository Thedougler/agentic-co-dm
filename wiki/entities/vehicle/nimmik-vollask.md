...
berth: unmoored
aliases: ["the Depot", Nimmik Vollask]
relationships:
...
> [!narration] Narration
> The *Nimmik Vollask* rides bright orange against grey water, boxy from bow to stern, with two-foot Gnomish letters running the length of both sides. A halfling woman waits at the starboard rail behind a folding table, ledger open, a coffee pot steaming at her elbow. Below the main hatch, gnomish voices count off a rhythm, and a cargo crane creaks as it swings out empty over the gap. Tar and frying meatballs drift up from the hold.
