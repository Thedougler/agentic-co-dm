...
The weather deck is plain and gives room for sail work and loading. A low deckhouse aft of the mainmast shelters the captain's quarters beneath it.

Below that, the gun deck runs amidships. Its ports remain closed against the sea, and its forward section serves as crew's mess and storage.

Lowest and deepest is the cargo hold. Barrels, crates, and sacks stack tight under six feet of headroom, lit by two lanterns and a gap above the waterline in the aft corner that lets in fresh air and a narrow strip of outside light.
