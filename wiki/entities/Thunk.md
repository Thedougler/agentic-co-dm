...
| **Role**     | *[[Uncertainty]]*'s gunner and field smith                         |
| ------------ | ------------------------------------------------------------------ |
| **Nature**   | Orc crewman with an uncanny sense for powder and cannons.         |
| **Home**     | [[Uncertainty]]                                                    |
| **Wants**    | Keep the ship mobile and its weapons ready.                       |
| **Pressure** | `1,000 gp` of cannons signed to ship credit while blackout drunk.  |
| **Limit**    | He knows when powder or metalwork is wrong; he cannot explain how. |

> **DM thesis:** Thunk is reliable with a cannon and dangerously casual with credit.
```
...
Thunk is a broad-shouldered, green-skinned orc with close-cropped dark hair and prominent tusks. He wears a rolled-sleeve white shirt beneath a dark apron, with a tool belt at his waist.
```
````

> [!narration] Thunk
> Thunk is a broad-shouldered orc with close-cropped dark hair, prominent tusks, and a white shirt rolled to the elbows beneath a dark apron. A tool belt hangs at his waist. He keeps one heavy hand on the cannon as if feeling for a problem in the metal.
...
Start Thunk with a job in progress: checking powder, repairing metalwork, or watching the guns. He answers direct questions plainly, but his attention stays on the ship.

**Sample line:** “That powder's wrong. Don't ask me how. Fix it.”
```
