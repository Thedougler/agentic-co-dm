...
visibility: dm
summary: "Fence for salvaged magic oddities; runs Ninka's Findings in Sparhold, trading items with no questions about provenance."
provenance:
  extracted: 0.85
  inferred: 0.10
  ambiguous: 0.05
...
**Wants:** establish herself as the indispensable salvage intermediary in [[Sparhold]] while a key [[Verdant Teeth]] contact has gone silent, leaving her inventory depleted and [[Catarina Da'Virelli|Catarina]] waiting on rare [[Antheri]] pieces.

*Ninka*: I don't ask where it came from. I don't ask where it's going. What it costs is what it costs.

> [!narration] Narration
> A lean figure in weathered leather, fingers stained with rust and salt. She works the beads of a bone abacus without looking up, tallying prices in a voice that renders each transaction in flat copper. By the time she meets your eyes, the sum is final.

## Roleplay Concept

Sparhold bureaucrat turned black-market trafficker, trades with the efficiency of a ledger keeper and the disinterest of someone processing invoices.

## Lore Sheet

Ninka runs [[Ninka's Findings]] from a reinforced shop in [[Sparhold|Sparhold's]] fortress-market district, wedged between supply traders and blacksmiths. She buys salvage from [[Verdant Teeth]] expeditions and wreck-divers, prices items by rarity and condition alone, and never volunteers buyer names to sellers or seller names to buyers. Three weeks without word from Vrex, her primary Teeth contact. She fills inventory gaps with lower stock while [[Catarina Da'Virelli]] waits on a promised [[Antheri]] component.
...
Ninka's speech is terse and transactional. She quotes prices and recites her rules. Direct questions get bare-fact answers. Her tone is flat and her pace unhurried, a bureaucrat filing paperwork. She invests in nothing beyond the transaction's completion.

*Ninka*: That's three hundred. You know the rules.

*Ninka*: Antheri work. Incomplete. Can't say what it does. That's the risk you take.
