...
sources:
  - "00 Story so far.md"
  - "campaign-os:zort.md"
summary: "Armless contact who offered a Midchain reptile lead for a prosthetic."
provenance:
  extracted: 1.0
  inferred: 0.0
  ambiguous: 0.0
...
- **Session 08** (`vault/episodes/008/`). Met [[Perrin Black-Jaw|Perrin]], [[Crissdalynn Khinriss|Crissdalynn]], [[Catarina Da'Virelli|Catarina]], and [[Delmar Fisk|Delmar]] at [[Zort's Pits]]. Warned them off the animal cages. Agreed to give Catarina his Mid-Chain reptile contact's name once she brings him a working prosthetic leg. Traded a high five with [[Perrin Black-Jaw|Perrin]] (a "sleight of foot" check). Confirmed: [[Transcript]].
