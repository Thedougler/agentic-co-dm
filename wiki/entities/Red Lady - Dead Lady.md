...
- **Speed.** The supplied vehicle source does not establish a movement rate.
- **Crew (min).** The minimum complement is not established. The drowned original crew works the decks in silence.
- **Passengers.** Capacity is not established. Crews taken by the Dead Lady are not described as surviving passengers.
- **Cargo.** Capacity is not established. Holds are dumped as part of the collection work.

## Components

- **Hull.** AC `12`; `230` hit points. The supplied chassis does not establish a damage threshold.
...
- **Weapons.** No weapon entries are established. The wreck takes boats and threatens crews through its approach, boarding access, and collection behaviour.

## Crew stations

The source names no living command crew or station assignments. The drowned original crew works the decks in silence, but the minimum staffing and the consequence of an empty station are unresolved.
