...
**If ahead:** Let the voice force one clear commitment, then stop. Keep [[Session-11-08-Night-Watch]] on its own card.
```
...
- **Situation magnets:** Any survivor who steps toward the north trail alone, and any party member who does the same.
```
````
...
````col
```col-md
**[[Deer-Stalker]].** Use one creature, not Famished. The garden voice draws a person away; it is not an opening attack. If the party stays grouped, the creature retreats without a fight.

- **Tell:** The whisper comes from the creature's space, so the party can tell its direction. Hearing the sound alone does not reveal the creature while it is Hidden.
...
```col-md
**Garden listeners.** These unnamed survivors heard the invitation and want to see the garden. They stand when the whisper comes.
...
> Night has taken the packed-dirt hub. Twenty feet north, a voice uses the words from the fire: come admire her garden, this way, leave the living plants. The same words return from deeper wood, stretched thin. No footprints join the sound.
>
> Some people at the fire turn north, and a few begin to rise. Heat burns in the ring of river stones while smoke presses beneath the leaves. Fallen stonepears lie beside the coals. Two spears and four woven mats mark the south side of the hub.
>
> Gold-green grass shows through the trees to the south. To the west, water speaks below hanging roots. North trails close between the trunks, and the packed dirt is hard beneath you. The voice repeats from that darkness.
>
> What do you do?
...
**Peel turn.** After everyone acts, tick once if anyone is isolated or a garden listener is walking toward the unanswered voice. A frozen round also ticks if a garden listener is standing or peeling away. Failed checks use only the listed **Be ready for** consequence; they do not advance the clock by themselves.
...
| ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| Assess the situation      | **Wisdom (Perception)**, **Wisdom (Survival)**, or **Intelligence (Nature)**                                                                   | `DC 10`                       | The fire still holds the packed hub. The garden voice comes from a north trail, but no footprints join it. Anyone who leaves this dirt is alone.                                                                                                                                                                                                                                           | The looker understands the fire-versus-whisper split but stays on the hub while the calls continue.                                    | The looker misses that split. Walking toward the sound still peels a person into the north trail. |
| Test the voices           | **Wisdom (Insight)**. A shouted question from the hub returns the same stretched garden words.                                                 | `DC 15`                       | The party member identifies an imitation. Apply Advantage if they heard the original mouths at this fire. Walking toward the voice still isolates them.                                                                                                                                                                                                                                    | The party member cannot settle whether the voice is real and leans toward the north trail. The [[Deer-Stalker]] keeps using the sound. | The party member treats the voice as the woman. It continues from the north trail.                |
| Stay grouped at this fire | Commit to holding the hub and ignoring the voice                                                                                               | Commit                        | The party holds the hub and keeps any standing garden listener beside the coals. There is no fight; the mark stays live. Hand to [[Session-11-08-Night-Watch]] when this scene ends.                                                                                                                                                                                                       | There is no partial result.                                                                                                            | This is binary. If anyone is peeling away, use the stop-peeler row or let the clock tick.         |
| Stop a peeling survivor   | **Charisma (Persuasion)** or **Charisma (Intimidation)** to stop a hesitant garden listener                                                    | `DC 15`                       | The survivor returns to the hub and the coals. The mark stays live.                                                                                                                                                                                                                                                                                                                        | The survivor hesitates at the trail mouth. The round is spent, and the clock ticks at its end if the survivor remains off the hub.     | The survivor keeps walking north and remains isolated.                                            |
...
**Scene dials.** Easy: one [[Deer-Stalker]] that is not Famished. Skip Snatch from the Dim on the opening walk. If every garden listener remains on the packed dirt and the party stays grouped, end the scene without another tick.
```
````
...
> The north trail goes quiet. Smoke presses beneath the leaves, and firelight marks the people gathered around the stones.
>
| If | Next | Narration |
| --- | --- | --- |
...
> A body taller than a man fills the gap between the north-trail trunks. Shaggy brown and cream fur hangs from its shoulders, and branching antlers rise above a long pale deer face. Its arms reach below its knees to black claws wet with blood; a red thread hangs from its muzzle. The garden words come from its throat. It leans forward and says, "You're not welcome here."
