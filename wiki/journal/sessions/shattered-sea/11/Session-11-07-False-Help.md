...
| Deeper wood | 50 feet north in the wood. | The [[Aruhe - Deerstalker]] pulls a loner this way, while a grouped answer drives it this way. A Dash does not reach [[Aruhe - Quiet Forest Star Cut]]. | ==_Past the first trail mouth the trunks pack tighter and the fire is already behind you. You see no packed prints here. The same whisper waits farther in, still using those garden words._== |
...
| Test the voices | **Wisdom (Insight)**. A shouted question from the hub returns the same stretched garden words. | `DC 15` | The party member knows the sound is an imitation. Apply Advantage if they heard the original mouths at this fire. Walking toward the voice still isolates them. | The party member remains unsure and leans toward the north trail. The [[Aruhe - Deerstalker]] keeps using the sound. | The party member treats the garden voice as the woman. The voice remains in the north trail. |
...
| Send one person | Walk toward the voice alone | Walk | The party member reaches the north-trail voice and becomes isolated. Speak the face lines, then let the [[Aruhe - Deerstalker]] attack. Switch to combat mode. | There is no partial result. A lone walk still isolates that party member. | The party member spends the round on the hub and does not reach the voice. |
...
| 3 | The garden mouth walks the north trail alone and becomes isolated. If the isolated body is a party member, speak the face lines and let the [[Aruhe - Deerstalker]] attack: Claw `+8` to hit for `12` slashing, reach `10 feet`, optional **Grappled** escape `DC 16`, Multiattack two Claws, This Meal extra `7` (`2d6`) while fewer than two other conscious creatures are within 10 feet. If it is a garden mouth and two ready hostiles are not within 30 feet, that person is lost into Quiet. The walk does not begin with Snatch from the Dim. | ==_The listener's back disappears between the big roots. The stretched garden words sit farther in that wood._== |
...
```col-md
**Bloodied 42 HP.** The [[Aruhe - Deerstalker]] has no extra bloodied action. It keeps the isolated quarry.
...
**Scene dials.** Easy: one [[Aruhe - Deerstalker]] that is not Famished. Skip Snatch from the Dim on the opening walk. If every garden mouth remains on the packed dirt and the party stays grouped, end the scene without another tick.
```
````
