...
When the crew navigates a new stretch of grassland or river, they make a **Wisdom (Survival) — `DC 13`** check. They need 3 successes to reach the next landmark: landing to smoke, or smoke to camp. Failures do not count toward that 3; use 2 successes if the night is short and 4 if they leave the water.
...
3. Resolve the hazard using the linked owner note. Do not copy its full mechanics onto this card.
4. Return to the survivor prints, smoke, or the next story beat when the crew clears the hazard.
